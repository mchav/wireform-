...
-- | Annotated fixture types for the BSON deriver round-trip tests.
module Test.BSON.Derive.Types (
  Profile (..),
  Tag (..),
  Color (..),
  Shape (..),
...
{-# ANN profilePrivate (forBackend backendBSON skip) #-}
{-# ANN profilePrivate (forBackend backendBSON (defaults 'defaultPrivate)) #-}
