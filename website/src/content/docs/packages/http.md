...
| `wireform-http1` | `Network.HTTP1.TLS` | `tls`-package bridge for HTTP/1 (legacy path); use [`Wireform.Network.TLS.OpenSSL`](../network/#tls-on-ring-via-openssl) for the ring-direct path |
