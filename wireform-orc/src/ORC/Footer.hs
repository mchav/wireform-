...
encodeColStats cs =
  mconcat
    [ maybe
        mempty
        (encodeVarintField ColumnStatistics_NumberOfValues)
        (csNumberOfValues cs)
    , maybe
        mempty
        ( \b ->
            encodeVarintField
              ColumnStatistics_HasNull
              (if b then 1 else 0 :: Word64)
        )
        (csHasNull cs)
    , maybe
        mempty
        (encodeVarintField ColumnStatistics_BytesOnDisk)
        (csBytesOnDisk cs)
...
encodeStatsKind = \case
  SkInt s ->
    encodeLengthDelim
      ColumnStatistics_IntStatistics
      (encodeIntStats s)
  SkDouble s ->
    encodeLengthDelim
      ColumnStatistics_DoubleStatistics
      (encodeDoubleStats s)
  SkString s ->
    encodeLengthDelim
      ColumnStatistics_StringStatistics
      (encodeStringStats s)
  SkBucket s ->
    encodeLengthDelim
      ColumnStatistics_BucketStatistics
      (encodeBucketStats s)
  SkDecimal s ->
    encodeLengthDelim
      ColumnStatistics_DecimalStatistics
      (encodeDecimalStats s)
  SkDate s ->
    encodeLengthDelim
      ColumnStatistics_DateStatistics
      (encodeDateStats s)
  SkBinary s ->
    encodeLengthDelim
      ColumnStatistics_BinaryStatistics
      (encodeBinaryStats s)
  SkTimestamp s ->
    encodeLengthDelim
      ColumnStatistics_TimestampStatistics
...
encodeStringStats s =
  mconcat
    [ maybe
        mempty
        ( encodeLengthDelim StringStatistics_Minimum
            . B.byteString
            . TE.encodeUtf8
        )
        (ssMinimum s)
    , maybe
        mempty
        ( encodeLengthDelim StringStatistics_Maximum
            . B.byteString
            . TE.encodeUtf8
        )
        (ssMaximum s)
    , maybe
        ...
        ( \v ->
            encodeVarintField
              StringStatistics_Sum
              (zigzag64 v)
        )
        (ssSum s)
    , maybe
        mempty
        ( encodeLengthDelim StringStatistics_LowerBound
            . B.byteString
            . TE.encodeUtf8
        )
        (ssLowerBound s)
    , maybe
        mempty
        ( encodeLengthDelim StringStatistics_UpperBound
            . B.byteString
            . TE.encodeUtf8
        )
        (ssUpperBound s)
...
encodeBinaryStats s =
  maybe
    mempty
    (\v -> encodeVarintField BinaryStatistics_Sum (zigzag64 v))
    (bsSum s)
...
encodeTimestampStats s =
  mconcat
    ...
    , maybe
        ...
        ( \v ->
            encodeVarintField
              TimestampStatistics_MinimumUtc
              (zigzag64 v)
        )
        (tsMinimumUtc s)
    , maybe
        ...
        ( \v ->
            encodeVarintField
              TimestampStatistics_MaximumUtc
              (zigzag64 v)
        )
        (tsMaximumUtc s)
    ]
...
encodeDecimalStats s =
  mconcat
    [ maybe
        mempty
        ( encodeLengthDelim DecimalStatistics_Minimum
            . B.byteString
            . TE.encodeUtf8
        )
        (decMinimum s)
    , maybe
        mempty
        ( encodeLengthDelim DecimalStatistics_Maximum
            . B.byteString
            . TE.encodeUtf8
        )
        (decMaximum s)
    , maybe
        mempty
        ( encodeLengthDelim DecimalStatistics_Sum
            . B.byteString
            . TE.encodeUtf8
        )
        (decSum s)
