...
import ORC.Footer
import ORC.Read
import ORC.Stripe (Stream (..), StripeFooter (..), decodeStripeFooter, encodeStripeFooter, stripeStreamSlices)
import ORC.Types
import ORC.Write
import Test.Syd
...
stripeFooterEncodeTests =
  describe "Stripe footer encoding" $
    sequence_
