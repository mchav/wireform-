...
flatBuffersTests = describe "FlatBuffers" $ sequence_
  [ rootShape
  , scalarRoundTrips
  , stringRoundTrips
  , viewRoundTrips
...
rootShape :: Spec
rootShape = describe "Root buffer shape" $ sequence_
...
scalarRoundTrips = describe "Scalar round-trip" $ sequence_
...
stringRoundTrips = describe "String" $ sequence_
...
viewRoundTrips :: Spec
viewRoundTrips = describe "View round-trips" $ sequence_
...
scalarProperties = describe "Property tests" $ sequence_
