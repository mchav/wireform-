...
-- | Annotated fixture types for the Avro deriver round-trip tests.
module Test.Avro.Derive.Types
  ( Profile (..)
  , Tag (..)
  , Color (..)
  , Shape (..)
...
{-# ANN profilePrivate (forBackend backendAvro skip) #-}
{-# ANN profilePrivate (forBackend backendAvro (defaults 'defaultPrivate)) #-}
