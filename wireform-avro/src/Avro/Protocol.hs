...
protocolToJSON proto = Aeson.Object $ KM.fromList $ catMaybes
  ...
  , if null (protoMessages proto)
    then Nothing
    else Just ("messages", Aeson.Object $ KM.fromList
...
messageToJSON msg = Aeson.Object $ KM.fromList $ catMaybes
  [ Just ("request", Aeson.Array $ V.fromList
...
data HandshakeMatch
  = MatchBoth   -- ^ Both client and server hashes match
  | MatchClient -- ^ Only client hash matches
  | MatchNone   -- ^ Neither matches
...
handshakeRequestToJSON req = Aeson.Object $ KM.fromList $ catMaybes
...
handshakeResponseToJSON resp = Aeson.Object $ KM.fromList $ catMaybes
...
metaToJSON entries = Aeson.Object $ KM.fromList
