...
import Hudi.IO qualified as HIO
          ...
          summary =
            Aeson.Object $
              KM.fromList
                ...
                ,
                  ( Key.fromString "latest_instant"
                  , case H.tsLatestInstant state of
                ...
                ,
                  ( Key.fromString "schema_json"
                  , case HIO.hutSchemaJson ht of
    ...
    pure $
      Aeson.Object $
        KM.fromList
          ...
          ,
            ( Key.fromString "base_file"
            , case H.fsBaseFile slice of
