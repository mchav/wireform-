...
tests :: Spec
tests = describe "encode" $ sequence_
  [ scalarOutput
  , collectionOutput
  , quotingTests
  ]
...
scalarOutput :: Spec
scalarOutput = describe "scalars" $ sequence_
...
collectionOutput = describe "collections" $ sequence_
...
quotingTests :: Spec
quotingTests = describe "quoting" $ sequence_
