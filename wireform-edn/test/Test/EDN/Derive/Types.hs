...
-- | Annotated fixture types for the EDN deriver round-trip tests.
module Test.EDN.Derive.Types
  ( Profile (..)
  , Tag (..)
  , Color (..)
  , Shape (..)
...
{-# ANN profilePrivate (forBackend backendEDN skip) #-}
{-# ANN profilePrivate (forBackend backendEDN (defaults 'defaultPrivate)) #-}
