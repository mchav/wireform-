...
import Control.Concurrent.STM (STM, TVar, TMVar, atomically)
...
import Network.HTTP2.Engine.Server qualified as HTTP2.Server
...
import Paths_wireform_grpc (getDataFileName)
...
isHandshakeFailed (WrapExactException e) =
    case fromException e of
      ...
      _otherwise -> case fromException e of
        Just (OpenSslError _) -> True
        _otherwise2 -> False
