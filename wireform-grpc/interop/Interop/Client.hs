...
import Interop.Client.TestCase.OrcaPerRpc                qualified as OrcaPerRpc
import Interop.Client.TestCase.OrcaOob                   qualified as OrcaOob
...
runTest TestOrcaPerRpc                = OrcaPerRpc.runTest
runTest TestOrcaOob                   = OrcaOob.runTest
