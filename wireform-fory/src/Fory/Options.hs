...
import Fory.Struct (StructSchema, ssNamespace, ssTypename)
...
data EncodeOptions = EncodeOptions
  { eoRefTracking    :: !Bool
    ...
    -- top level and around explicit 'Fory.Value.RefVal' nodes.
  , eoStructRegistry :: !StructRegistry
    -- ^ Schemas keyed by @(namespace, type_name)@. When the
    -- encoder sees a 'Fory.Value.RegisteredStructVal' whose
