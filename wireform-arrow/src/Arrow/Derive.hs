...
rejectEnumOrSum nm shape =
  "Arrow.Derive: cannot derive Arrow instances for "
    ++ shape
    ++ " type "
    ++ show nm
...
requireSelector Nothing =
  fail
    "Arrow.Derive: cannot derive Arrow instances for a positional \
