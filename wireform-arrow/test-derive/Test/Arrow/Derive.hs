...
tests :: Spec
tests = describe "Arrow.Derive" $ sequence_
  [ recordTests
  , newtypeTests
  , maybeTests
  , coercedTests
...
newtypeTests :: Spec
newtypeTests = describe "newtype-passthrough" $ sequence_
...
maybeTests :: Spec
maybeTests = describe "Maybe-fields" $ sequence_
...
spliceFailureTests = describe "splice-time-rejection" $ sequence_
