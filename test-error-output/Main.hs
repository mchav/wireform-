...
main = do
  ...
  test "Bad syntax declaration"
    "syntax = \"proto4\";\n"

  test "Missing equals in field"
    "syntax = \"proto3\";\nmessage Foo {\n  string name 1;\n}\n"

  test "Missing field number"
    "syntax = \"proto3\";\nmessage Foo {\n  string name = ;\n}\n"
  ...
  test "Missing comma in map type"
    "syntax = \"proto3\";\nmessage Foo {\n  map<string int32> x = 1;\n}\n"

  test "Error deep in file"
    (T.unlines
      [ "syntax = \"proto3\";"
      , "package myapp.users;"
      , ""
  ...
  test "Missing message name"
    "syntax = \"proto3\";\nmessage {\n  string name = 1;\n}\n"

  test "Duplicate semicolons"
    "syntax = \"proto3\";\nmessage Foo {\n  string name = 1;;\n}\n"
