...
import Proto.Temporalio.Api.Enums.V1.Reset qualified as TE_Enums_V1_Reset
...
defaultPayload'ExternalPayloadDetails =
...
defaultWorkerVersionCapabilities =
...
instance MessageSize ResetOptions where
  messageSize msg =
    ( case msg.resetOptionsTarget of
        Nothing -> 0
        Just (ResetOptions'Target'FirstWorkflowTask v) -> fieldMessageSize 1 (messageSize v)
...
instance MessageSize Callback where
  messageSize msg =
    ( case msg.callbackVariant of
        Nothing -> 0
        Just (Callback'Variant'Nexus v) -> fieldMessageSize 2 (messageSize v)
...
defaultLink'WorkflowEvent'EventReference =
...
defaultLink'WorkflowEvent'RequestIdReference =
...
instance MessageSize Link'WorkflowEvent where
  messageSize msg =
    (if msg.linkWorkflowEventNamespace == T.empty then 0 else fieldTextSize 1 msg.linkWorkflowEventNamespace)
      ...
      + ( case msg.linkWorkflowEventReference of
            Nothing -> 0
            Just (Link'WorkflowEvent'Reference'EventRef v) -> fieldMessageSize 100 (messageSize v)
...
instance MessageSize Link where
  messageSize msg =
    ( case msg.linkVariant of
        Nothing -> 0
        Just (Link'Variant'WorkflowEvent v) -> fieldMessageSize 1 (messageSize v)
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy DataBlob)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy WorkerSelector)
    . id
