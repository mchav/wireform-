...
import Proto.Temporalio.Api.Enums.V1.BatchOperation qualified as TE_Enums_V1_BatchOperation
import Proto.Temporalio.Api.Enums.V1.Reset qualified as TE_Enums_V1_Reset
import Proto.Temporalio.Api.Rules.V1.Message qualified as TE_Rules_V1_Message
...
defaultBatchOperationTermination =
...
defaultBatchOperationCancellation =
...
defaultBatchOperationUpdateWorkflowExecutionOptions =
...
defaultBatchOperationUnpauseActivities =
...
instance MessageSize BatchOperationUnpauseActivities where
  messageSize msg =
    (if msg.batchOperationUnpauseActivitiesIdentity == T.empty then 0 else fieldTextSize 1 msg.batchOperationUnpauseActivitiesIdentity)
      + ( case msg.batchOperationUnpauseActivitiesActivity of
            Nothing -> 0
            Just (BatchOperationUnpauseActivities'Activity'Type v) -> fieldTextSize 2 v
...
defaultBatchOperationTriggerWorkflowRule =
...
instance MessageSize BatchOperationTriggerWorkflowRule where
  messageSize msg =
    (if msg.batchOperationTriggerWorkflowRuleIdentity == T.empty then 0 else fieldTextSize 1 msg.batchOperationTriggerWorkflowRuleIdentity)
      + ( case msg.batchOperationTriggerWorkflowRuleRule of
            Nothing -> 0
            Just (BatchOperationTriggerWorkflowRule'Rule'Id v) -> fieldTextSize 2 v
...
defaultBatchOperationResetActivities =
...
instance MessageSize BatchOperationResetActivities where
  messageSize msg =
    (if msg.batchOperationResetActivitiesIdentity == T.empty then 0 else fieldTextSize 1 msg.batchOperationResetActivitiesIdentity)
      + ( case msg.batchOperationResetActivitiesActivity of
            Nothing -> 0
            Just (BatchOperationResetActivities'Activity'Type v) -> fieldTextSize 2 v
...
defaultBatchOperationUpdateActivityOptions =
...
instance MessageSize BatchOperationUpdateActivityOptions where
  messageSize msg =
    (if msg.batchOperationUpdateActivityOptionsIdentity == T.empty then 0 else fieldTextSize 1 msg.batchOperationUpdateActivityOptionsIdentity)
      + ( case msg.batchOperationUpdateActivityOptionsActivity of
            Nothing -> 0
            Just (BatchOperationUpdateActivityOptions'Activity'Type v) -> fieldTextSize 2 v
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy BatchOperationInfo)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy BatchOperationUpdateActivityOptions)
    . id
