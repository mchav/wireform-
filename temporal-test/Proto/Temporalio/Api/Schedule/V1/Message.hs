...
import Proto.Temporalio.Api.Enums.V1.Schedule qualified as TE_Enums_V1_Schedule
...
defaultTriggerImmediatelyRequest =
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy CalendarSpec)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy ScheduleListEntry)
    . id
