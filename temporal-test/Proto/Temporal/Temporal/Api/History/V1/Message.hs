...
instance ProtoFromJSON WorkflowExecutionStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionStartedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_workflowExecutionStartedEventAttributesParentworkflownamespace <- obj .:? "parentWorkflowNamespace"
    v_workflowExecutionStartedEventAttributesParentworkflownamespaceid <- obj .:? "parentWorkflowNamespaceId"
    v_workflowExecutionStartedEventAttributesParentworkflowexecution <- obj .:? "parentWorkflowExecution"
    v_workflowExecutionStartedEventAttributesParentinitiatedeventid <- obj .:? "parentInitiatedEventId"
    v_workflowExecutionStartedEventAttributesTaskqueue <- obj .:? "taskQueue"
    v_workflowExecutionStartedEventAttributesInput <- obj .:? "input"
    v_workflowExecutionStartedEventAttributesWorkflowexecutiontimeout <- obj .:? "workflowExecutionTimeout"
    v_workflowExecutionStartedEventAttributesWorkflowruntimeout <- obj .:? "workflowRunTimeout"
    v_workflowExecutionStartedEventAttributesWorkflowtasktimeout <- obj .:? "workflowTaskTimeout"
    v_workflowExecutionStartedEventAttributesContinuedexecutionrunid <- obj .:? "continuedExecutionRunId"
    v_workflowExecutionStartedEventAttributesInitiator <- obj .:? "initiator"
    v_workflowExecutionStartedEventAttributesContinuedfailure <- obj .:? "continuedFailure"
    v_workflowExecutionStartedEventAttributesLastcompletionresult <- obj .:? "lastCompletionResult"
    v_workflowExecutionStartedEventAttributesOriginalexecutionrunid <- obj .:? "originalExecutionRunId"
    v_workflowExecutionStartedEventAttributesIdentity <- obj .:? "identity"
    v_workflowExecutionStartedEventAttributesFirstexecutionrunid <- obj .:? "firstExecutionRunId"
    v_workflowExecutionStartedEventAttributesRetrypolicy <- obj .:? "retryPolicy"
    v_workflowExecutionStartedEventAttributesAttempt <- obj .:? "attempt"
    v_workflowExecutionStartedEventAttributesWorkflowexecutionexpirationtime <- obj .:? "workflowExecutionExpirationTime"
    v_workflowExecutionStartedEventAttributesCronschedule <- obj .:? "cronSchedule"
    v_workflowExecutionStartedEventAttributesFirstworkflowtaskbackoff <- obj .:? "firstWorkflowTaskBackoff"
    v_workflowExecutionStartedEventAttributesMemo <- obj .:? "memo"
    v_workflowExecutionStartedEventAttributesSearchattributes <- obj .:? "searchAttributes"
    v_workflowExecutionStartedEventAttributesPrevautoresetpoints <- obj .:? "prevAutoResetPoints"
    v_workflowExecutionStartedEventAttributesHeader <- obj .:? "header"
    v_workflowExecutionStartedEventAttributesParentinitiatedeventversion <- obj .:? "parentInitiatedEventVersion"
    v_workflowExecutionStartedEventAttributesWorkflowid <- obj .:? "workflowId"
    v_workflowExecutionStartedEventAttributesSourceversionstamp <- obj .:? "sourceVersionStamp"
    v_workflowExecutionStartedEventAttributesCompletioncallbacks <- obj .:? "completionCallbacks"
    v_workflowExecutionStartedEventAttributesRootworkflowexecution <- obj .:? "rootWorkflowExecution"
    v_workflowExecutionStartedEventAttributesInheritedbuildid <- obj .:? "inheritedBuildId"
    v_workflowExecutionStartedEventAttributesVersioningoverride <- obj .:? "versioningOverride"
    v_workflowExecutionStartedEventAttributesParentpinnedworkerdeploymentversion <- obj .:? "parentPinnedWorkerDeploymentVersion"
    v_workflowExecutionStartedEventAttributesPriority <- obj .:? "priority"
    v_workflowExecutionStartedEventAttributesInheritedpinnedversion <- obj .:? "inheritedPinnedVersion"
    v_workflowExecutionStartedEventAttributesInheritedautoupgradeinfo <- obj .:? "inheritedAutoUpgradeInfo"
    v_workflowExecutionStartedEventAttributesEagerexecutionaccepted <- obj .:? "eagerExecutionAccepted"
    pure (WorkflowExecutionStartedEventAttributes {
       workflowExecutionStartedEventAttributesWorkflowtype = v_workflowExecutionStartedEventAttributesWorkflowtype
      , workflowExecutionStartedEventAttributesParentworkflownamespace = v_workflowExecutionStartedEventAttributesParentworkflownamespace
      , workflowExecutionStartedEventAttributesParentworkflownamespaceid = v_workflowExecutionStartedEventAttributesParentworkflownamespaceid
      , workflowExecutionStartedEventAttributesParentworkflowexecution = v_workflowExecutionStartedEventAttributesParentworkflowexecution
      , workflowExecutionStartedEventAttributesParentinitiatedeventid = v_workflowExecutionStartedEventAttributesParentinitiatedeventid
      , workflowExecutionStartedEventAttributesTaskqueue = v_workflowExecutionStartedEventAttributesTaskqueue
      , workflowExecutionStartedEventAttributesInput = v_workflowExecutionStartedEventAttributesInput
      , workflowExecutionStartedEventAttributesWorkflowexecutiontimeout = v_workflowExecutionStartedEventAttributesWorkflowexecutiontimeout
      , workflowExecutionStartedEventAttributesWorkflowruntimeout = v_workflowExecutionStartedEventAttributesWorkflowruntimeout
      , workflowExecutionStartedEventAttributesWorkflowtasktimeout = v_workflowExecutionStartedEventAttributesWorkflowtasktimeout
      , workflowExecutionStartedEventAttributesContinuedexecutionrunid = v_workflowExecutionStartedEventAttributesContinuedexecutionrunid
      , workflowExecutionStartedEventAttributesInitiator = v_workflowExecutionStartedEventAttributesInitiator
      , workflowExecutionStartedEventAttributesContinuedfailure = v_workflowExecutionStartedEventAttributesContinuedfailure
      , workflowExecutionStartedEventAttributesLastcompletionresult = v_workflowExecutionStartedEventAttributesLastcompletionresult
      , workflowExecutionStartedEventAttributesOriginalexecutionrunid = v_workflowExecutionStartedEventAttributesOriginalexecutionrunid
      , workflowExecutionStartedEventAttributesIdentity = v_workflowExecutionStartedEventAttributesIdentity
      , workflowExecutionStartedEventAttributesFirstexecutionrunid = v_workflowExecutionStartedEventAttributesFirstexecutionrunid
      , workflowExecutionStartedEventAttributesRetrypolicy = v_workflowExecutionStartedEventAttributesRetrypolicy
      , workflowExecutionStartedEventAttributesAttempt = v_workflowExecutionStartedEventAttributesAttempt
      , workflowExecutionStartedEventAttributesWorkflowexecutionexpirationtime = v_workflowExecutionStartedEventAttributesWorkflowexecutionexpirationtime
      , workflowExecutionStartedEventAttributesCronschedule = v_workflowExecutionStartedEventAttributesCronschedule
      , workflowExecutionStartedEventAttributesFirstworkflowtaskbackoff = v_workflowExecutionStartedEventAttributesFirstworkflowtaskbackoff
      , workflowExecutionStartedEventAttributesMemo = v_workflowExecutionStartedEventAttributesMemo
      , workflowExecutionStartedEventAttributesSearchattributes = v_workflowExecutionStartedEventAttributesSearchattributes
      , workflowExecutionStartedEventAttributesPrevautoresetpoints = v_workflowExecutionStartedEventAttributesPrevautoresetpoints
      , workflowExecutionStartedEventAttributesHeader = v_workflowExecutionStartedEventAttributesHeader
      , workflowExecutionStartedEventAttributesParentinitiatedeventversion = v_workflowExecutionStartedEventAttributesParentinitiatedeventversion
      , workflowExecutionStartedEventAttributesWorkflowid = v_workflowExecutionStartedEventAttributesWorkflowid
      , workflowExecutionStartedEventAttributesSourceversionstamp = v_workflowExecutionStartedEventAttributesSourceversionstamp
      , workflowExecutionStartedEventAttributesCompletioncallbacks = v_workflowExecutionStartedEventAttributesCompletioncallbacks
      , workflowExecutionStartedEventAttributesRootworkflowexecution = v_workflowExecutionStartedEventAttributesRootworkflowexecution
      , workflowExecutionStartedEventAttributesInheritedbuildid = v_workflowExecutionStartedEventAttributesInheritedbuildid
      , workflowExecutionStartedEventAttributesVersioningoverride = v_workflowExecutionStartedEventAttributesVersioningoverride
      , workflowExecutionStartedEventAttributesParentpinnedworkerdeploymentversion = v_workflowExecutionStartedEventAttributesParentpinnedworkerdeploymentversion
      , workflowExecutionStartedEventAttributesPriority = v_workflowExecutionStartedEventAttributesPriority
      , workflowExecutionStartedEventAttributesInheritedpinnedversion = v_workflowExecutionStartedEventAttributesInheritedpinnedversion
      , workflowExecutionStartedEventAttributesInheritedautoupgradeinfo = v_workflowExecutionStartedEventAttributesInheritedautoupgradeinfo
      , workflowExecutionStartedEventAttributesEagerexecutionaccepted = v_workflowExecutionStartedEventAttributesEagerexecutionaccepted
    })
...
instance ProtoFromJSON WorkflowExecutionCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionCompletedEventAttributesResult <- obj .:? "result"
    v_workflowExecutionCompletedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_workflowExecutionCompletedEventAttributesNewexecutionrunid <- obj .:? "newExecutionRunId"
    pure (WorkflowExecutionCompletedEventAttributes {
       workflowExecutionCompletedEventAttributesResult = v_workflowExecutionCompletedEventAttributesResult
      , workflowExecutionCompletedEventAttributesWorkflowtaskcompletedeventid = v_workflowExecutionCompletedEventAttributesWorkflowtaskcompletedeventid
      , workflowExecutionCompletedEventAttributesNewexecutionrunid = v_workflowExecutionCompletedEventAttributesNewexecutionrunid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionFailedEventAttributesFailure <- obj .:? "failure"
    v_workflowExecutionFailedEventAttributesRetrystate <- obj .:? "retryState"
    v_workflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_workflowExecutionFailedEventAttributesNewexecutionrunid <- obj .:? "newExecutionRunId"
    pure (WorkflowExecutionFailedEventAttributes {
       workflowExecutionFailedEventAttributesFailure = v_workflowExecutionFailedEventAttributesFailure
      , workflowExecutionFailedEventAttributesRetrystate = v_workflowExecutionFailedEventAttributesRetrystate
      , workflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid = v_workflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid
      , workflowExecutionFailedEventAttributesNewexecutionrunid = v_workflowExecutionFailedEventAttributesNewexecutionrunid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionTimedOutEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionTimedOutEventAttributesRetrystate <- obj .:? "retryState"
    v_workflowExecutionTimedOutEventAttributesNewexecutionrunid <- obj .:? "newExecutionRunId"
    pure (WorkflowExecutionTimedOutEventAttributes {
       workflowExecutionTimedOutEventAttributesRetrystate = v_workflowExecutionTimedOutEventAttributesRetrystate
      , workflowExecutionTimedOutEventAttributesNewexecutionrunid = v_workflowExecutionTimedOutEventAttributesNewexecutionrunid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionContinuedAsNewEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionContinuedAsNewEventAttributesNewexecutionrunid <- obj .:? "newExecutionRunId"
    v_workflowExecutionContinuedAsNewEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_workflowExecutionContinuedAsNewEventAttributesTaskqueue <- obj .:? "taskQueue"
    v_workflowExecutionContinuedAsNewEventAttributesInput <- obj .:? "input"
    v_workflowExecutionContinuedAsNewEventAttributesWorkflowruntimeout <- obj .:? "workflowRunTimeout"
    v_workflowExecutionContinuedAsNewEventAttributesWorkflowtasktimeout <- obj .:? "workflowTaskTimeout"
    v_workflowExecutionContinuedAsNewEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_workflowExecutionContinuedAsNewEventAttributesBackoffstartinterval <- obj .:? "backoffStartInterval"
    v_workflowExecutionContinuedAsNewEventAttributesInitiator <- obj .:? "initiator"
    v_workflowExecutionContinuedAsNewEventAttributesFailure <- obj .:? "failure"
    v_workflowExecutionContinuedAsNewEventAttributesLastcompletionresult <- obj .:? "lastCompletionResult"
    v_workflowExecutionContinuedAsNewEventAttributesHeader <- obj .:? "header"
    v_workflowExecutionContinuedAsNewEventAttributesMemo <- obj .:? "memo"
    v_workflowExecutionContinuedAsNewEventAttributesSearchattributes <- obj .:? "searchAttributes"
    v_workflowExecutionContinuedAsNewEventAttributesInheritbuildid <- obj .:? "inheritBuildId"
    v_workflowExecutionContinuedAsNewEventAttributesInitialversioningbehavior <- obj .:? "initialVersioningBehavior"
    pure (WorkflowExecutionContinuedAsNewEventAttributes {
       workflowExecutionContinuedAsNewEventAttributesNewexecutionrunid = v_workflowExecutionContinuedAsNewEventAttributesNewexecutionrunid
      , workflowExecutionContinuedAsNewEventAttributesWorkflowtype = v_workflowExecutionContinuedAsNewEventAttributesWorkflowtype
      , workflowExecutionContinuedAsNewEventAttributesTaskqueue = v_workflowExecutionContinuedAsNewEventAttributesTaskqueue
      , workflowExecutionContinuedAsNewEventAttributesInput = v_workflowExecutionContinuedAsNewEventAttributesInput
      , workflowExecutionContinuedAsNewEventAttributesWorkflowruntimeout = v_workflowExecutionContinuedAsNewEventAttributesWorkflowruntimeout
      , workflowExecutionContinuedAsNewEventAttributesWorkflowtasktimeout = v_workflowExecutionContinuedAsNewEventAttributesWorkflowtasktimeout
      , workflowExecutionContinuedAsNewEventAttributesWorkflowtaskcompletedeventid = v_workflowExecutionContinuedAsNewEventAttributesWorkflowtaskcompletedeventid
      , workflowExecutionContinuedAsNewEventAttributesBackoffstartinterval = v_workflowExecutionContinuedAsNewEventAttributesBackoffstartinterval
      , workflowExecutionContinuedAsNewEventAttributesInitiator = v_workflowExecutionContinuedAsNewEventAttributesInitiator
      , workflowExecutionContinuedAsNewEventAttributesFailure = v_workflowExecutionContinuedAsNewEventAttributesFailure
      , workflowExecutionContinuedAsNewEventAttributesLastcompletionresult = v_workflowExecutionContinuedAsNewEventAttributesLastcompletionresult
      , workflowExecutionContinuedAsNewEventAttributesHeader = v_workflowExecutionContinuedAsNewEventAttributesHeader
      , workflowExecutionContinuedAsNewEventAttributesMemo = v_workflowExecutionContinuedAsNewEventAttributesMemo
      , workflowExecutionContinuedAsNewEventAttributesSearchattributes = v_workflowExecutionContinuedAsNewEventAttributesSearchattributes
      , workflowExecutionContinuedAsNewEventAttributesInheritbuildid = v_workflowExecutionContinuedAsNewEventAttributesInheritbuildid
      , workflowExecutionContinuedAsNewEventAttributesInitialversioningbehavior = v_workflowExecutionContinuedAsNewEventAttributesInitialversioningbehavior
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowTaskScheduledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowTaskScheduledEventAttributesTaskqueue <- obj .:? "taskQueue"
    v_workflowTaskScheduledEventAttributesStarttoclosetimeout <- obj .:? "startToCloseTimeout"
    v_workflowTaskScheduledEventAttributesAttempt <- obj .:? "attempt"
    pure (WorkflowTaskScheduledEventAttributes {
       workflowTaskScheduledEventAttributesTaskqueue = v_workflowTaskScheduledEventAttributesTaskqueue
      , workflowTaskScheduledEventAttributesStarttoclosetimeout = v_workflowTaskScheduledEventAttributesStarttoclosetimeout
      , workflowTaskScheduledEventAttributesAttempt = v_workflowTaskScheduledEventAttributesAttempt
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowTaskStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowTaskStartedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_workflowTaskStartedEventAttributesIdentity <- obj .:? "identity"
    v_workflowTaskStartedEventAttributesRequestid <- obj .:? "requestId"
    v_workflowTaskStartedEventAttributesSuggestcontinueasnew <- obj .:? "suggestContinueAsNew"
    v_workflowTaskStartedEventAttributesSuggestcontinueasnewreasons <- obj .:? "suggestContinueAsNewReasons"
    v_workflowTaskStartedEventAttributesTargetworkerdeploymentversionchanged <- obj .:? "targetWorkerDeploymentVersionChanged"
    v_workflowTaskStartedEventAttributesHistorysizebytes <- obj .:? "historySizeBytes"
    v_workflowTaskStartedEventAttributesWorkerversion <- obj .:? "workerVersion"
    v_workflowTaskStartedEventAttributesBuildidredirectcounter <- obj .:? "buildIdRedirectCounter"
    pure (WorkflowTaskStartedEventAttributes {
       workflowTaskStartedEventAttributesScheduledeventid = v_workflowTaskStartedEventAttributesScheduledeventid
      , workflowTaskStartedEventAttributesIdentity = v_workflowTaskStartedEventAttributesIdentity
      , workflowTaskStartedEventAttributesRequestid = v_workflowTaskStartedEventAttributesRequestid
      , workflowTaskStartedEventAttributesSuggestcontinueasnew = v_workflowTaskStartedEventAttributesSuggestcontinueasnew
      , workflowTaskStartedEventAttributesSuggestcontinueasnewreasons = v_workflowTaskStartedEventAttributesSuggestcontinueasnewreasons
      , workflowTaskStartedEventAttributesTargetworkerdeploymentversionchanged = v_workflowTaskStartedEventAttributesTargetworkerdeploymentversionchanged
      , workflowTaskStartedEventAttributesHistorysizebytes = v_workflowTaskStartedEventAttributesHistorysizebytes
      , workflowTaskStartedEventAttributesWorkerversion = v_workflowTaskStartedEventAttributesWorkerversion
      , workflowTaskStartedEventAttributesBuildidredirectcounter = v_workflowTaskStartedEventAttributesBuildidredirectcounter
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowTaskCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowTaskCompletedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_workflowTaskCompletedEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_workflowTaskCompletedEventAttributesIdentity <- obj .:? "identity"
    v_workflowTaskCompletedEventAttributesBinarychecksum <- obj .:? "binaryChecksum"
    v_workflowTaskCompletedEventAttributesWorkerversion <- obj .:? "workerVersion"
    v_workflowTaskCompletedEventAttributesSdkmetadata <- obj .:? "sdkMetadata"
    v_workflowTaskCompletedEventAttributesMeteringmetadata <- obj .:? "meteringMetadata"
    v_workflowTaskCompletedEventAttributesDeployment <- obj .:? "deployment"
    v_workflowTaskCompletedEventAttributesVersioningbehavior <- obj .:? "versioningBehavior"
    v_workflowTaskCompletedEventAttributesWorkerdeploymentversion <- obj .:? "workerDeploymentVersion"
    v_workflowTaskCompletedEventAttributesWorkerdeploymentname <- obj .:? "workerDeploymentName"
    v_workflowTaskCompletedEventAttributesDeploymentversion <- obj .:? "deploymentVersion"
    pure (WorkflowTaskCompletedEventAttributes {
       workflowTaskCompletedEventAttributesScheduledeventid = v_workflowTaskCompletedEventAttributesScheduledeventid
      , workflowTaskCompletedEventAttributesStartedeventid = v_workflowTaskCompletedEventAttributesStartedeventid
      , workflowTaskCompletedEventAttributesIdentity = v_workflowTaskCompletedEventAttributesIdentity
      , workflowTaskCompletedEventAttributesBinarychecksum = v_workflowTaskCompletedEventAttributesBinarychecksum
      , workflowTaskCompletedEventAttributesWorkerversion = v_workflowTaskCompletedEventAttributesWorkerversion
      , workflowTaskCompletedEventAttributesSdkmetadata = v_workflowTaskCompletedEventAttributesSdkmetadata
      , workflowTaskCompletedEventAttributesMeteringmetadata = v_workflowTaskCompletedEventAttributesMeteringmetadata
      , workflowTaskCompletedEventAttributesDeployment = v_workflowTaskCompletedEventAttributesDeployment
      , workflowTaskCompletedEventAttributesVersioningbehavior = v_workflowTaskCompletedEventAttributesVersioningbehavior
      , workflowTaskCompletedEventAttributesWorkerdeploymentversion = v_workflowTaskCompletedEventAttributesWorkerdeploymentversion
      , workflowTaskCompletedEventAttributesWorkerdeploymentname = v_workflowTaskCompletedEventAttributesWorkerdeploymentname
      , workflowTaskCompletedEventAttributesDeploymentversion = v_workflowTaskCompletedEventAttributesDeploymentversion
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowTaskTimedOutEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowTaskTimedOutEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_workflowTaskTimedOutEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_workflowTaskTimedOutEventAttributesTimeouttype <- obj .:? "timeoutType"
    pure (WorkflowTaskTimedOutEventAttributes {
       workflowTaskTimedOutEventAttributesScheduledeventid = v_workflowTaskTimedOutEventAttributesScheduledeventid
      , workflowTaskTimedOutEventAttributesStartedeventid = v_workflowTaskTimedOutEventAttributesStartedeventid
      , workflowTaskTimedOutEventAttributesTimeouttype = v_workflowTaskTimedOutEventAttributesTimeouttype
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowTaskFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowTaskFailedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_workflowTaskFailedEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_workflowTaskFailedEventAttributesCause <- obj .:? "cause"
    v_workflowTaskFailedEventAttributesFailure <- obj .:? "failure"
    v_workflowTaskFailedEventAttributesIdentity <- obj .:? "identity"
    v_workflowTaskFailedEventAttributesBaserunid <- obj .:? "baseRunId"
    v_workflowTaskFailedEventAttributesNewrunid <- obj .:? "newRunId"
    v_workflowTaskFailedEventAttributesForkeventversion <- obj .:? "forkEventVersion"
    v_workflowTaskFailedEventAttributesBinarychecksum <- obj .:? "binaryChecksum"
    v_workflowTaskFailedEventAttributesWorkerversion <- obj .:? "workerVersion"
    pure (WorkflowTaskFailedEventAttributes {
       workflowTaskFailedEventAttributesScheduledeventid = v_workflowTaskFailedEventAttributesScheduledeventid
      , workflowTaskFailedEventAttributesStartedeventid = v_workflowTaskFailedEventAttributesStartedeventid
      , workflowTaskFailedEventAttributesCause = v_workflowTaskFailedEventAttributesCause
      , workflowTaskFailedEventAttributesFailure = v_workflowTaskFailedEventAttributesFailure
      , workflowTaskFailedEventAttributesIdentity = v_workflowTaskFailedEventAttributesIdentity
      , workflowTaskFailedEventAttributesBaserunid = v_workflowTaskFailedEventAttributesBaserunid
      , workflowTaskFailedEventAttributesNewrunid = v_workflowTaskFailedEventAttributesNewrunid
      , workflowTaskFailedEventAttributesForkeventversion = v_workflowTaskFailedEventAttributesForkeventversion
      , workflowTaskFailedEventAttributesBinarychecksum = v_workflowTaskFailedEventAttributesBinarychecksum
      , workflowTaskFailedEventAttributesWorkerversion = v_workflowTaskFailedEventAttributesWorkerversion
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskScheduledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskScheduledEventAttributesActivityid <- obj .:? "activityId"
    v_activityTaskScheduledEventAttributesActivitytype <- obj .:? "activityType"
    v_activityTaskScheduledEventAttributesTaskqueue <- obj .:? "taskQueue"
    v_activityTaskScheduledEventAttributesHeader <- obj .:? "header"
    v_activityTaskScheduledEventAttributesInput <- obj .:? "input"
    v_activityTaskScheduledEventAttributesScheduletoclosetimeout <- obj .:? "scheduleToCloseTimeout"
    v_activityTaskScheduledEventAttributesScheduletostarttimeout <- obj .:? "scheduleToStartTimeout"
    v_activityTaskScheduledEventAttributesStarttoclosetimeout <- obj .:? "startToCloseTimeout"
    v_activityTaskScheduledEventAttributesHeartbeattimeout <- obj .:? "heartbeatTimeout"
    v_activityTaskScheduledEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_activityTaskScheduledEventAttributesRetrypolicy <- obj .:? "retryPolicy"
    v_activityTaskScheduledEventAttributesUseworkflowbuildid <- obj .:? "useWorkflowBuildId"
    v_activityTaskScheduledEventAttributesPriority <- obj .:? "priority"
    pure (ActivityTaskScheduledEventAttributes {
       activityTaskScheduledEventAttributesActivityid = v_activityTaskScheduledEventAttributesActivityid
      , activityTaskScheduledEventAttributesActivitytype = v_activityTaskScheduledEventAttributesActivitytype
      , activityTaskScheduledEventAttributesTaskqueue = v_activityTaskScheduledEventAttributesTaskqueue
      , activityTaskScheduledEventAttributesHeader = v_activityTaskScheduledEventAttributesHeader
      , activityTaskScheduledEventAttributesInput = v_activityTaskScheduledEventAttributesInput
      , activityTaskScheduledEventAttributesScheduletoclosetimeout = v_activityTaskScheduledEventAttributesScheduletoclosetimeout
      , activityTaskScheduledEventAttributesScheduletostarttimeout = v_activityTaskScheduledEventAttributesScheduletostarttimeout
      , activityTaskScheduledEventAttributesStarttoclosetimeout = v_activityTaskScheduledEventAttributesStarttoclosetimeout
      , activityTaskScheduledEventAttributesHeartbeattimeout = v_activityTaskScheduledEventAttributesHeartbeattimeout
      , activityTaskScheduledEventAttributesWorkflowtaskcompletedeventid = v_activityTaskScheduledEventAttributesWorkflowtaskcompletedeventid
      , activityTaskScheduledEventAttributesRetrypolicy = v_activityTaskScheduledEventAttributesRetrypolicy
      , activityTaskScheduledEventAttributesUseworkflowbuildid = v_activityTaskScheduledEventAttributesUseworkflowbuildid
      , activityTaskScheduledEventAttributesPriority = v_activityTaskScheduledEventAttributesPriority
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskStartedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskStartedEventAttributesIdentity <- obj .:? "identity"
    v_activityTaskStartedEventAttributesRequestid <- obj .:? "requestId"
    v_activityTaskStartedEventAttributesAttempt <- obj .:? "attempt"
    v_activityTaskStartedEventAttributesLastfailure <- obj .:? "lastFailure"
    v_activityTaskStartedEventAttributesWorkerversion <- obj .:? "workerVersion"
    v_activityTaskStartedEventAttributesBuildidredirectcounter <- obj .:? "buildIdRedirectCounter"
    pure (ActivityTaskStartedEventAttributes {
       activityTaskStartedEventAttributesScheduledeventid = v_activityTaskStartedEventAttributesScheduledeventid
      , activityTaskStartedEventAttributesIdentity = v_activityTaskStartedEventAttributesIdentity
      , activityTaskStartedEventAttributesRequestid = v_activityTaskStartedEventAttributesRequestid
      , activityTaskStartedEventAttributesAttempt = v_activityTaskStartedEventAttributesAttempt
      , activityTaskStartedEventAttributesLastfailure = v_activityTaskStartedEventAttributesLastfailure
      , activityTaskStartedEventAttributesWorkerversion = v_activityTaskStartedEventAttributesWorkerversion
      , activityTaskStartedEventAttributesBuildidredirectcounter = v_activityTaskStartedEventAttributesBuildidredirectcounter
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskCompletedEventAttributesResult <- obj .:? "result"
    v_activityTaskCompletedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskCompletedEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_activityTaskCompletedEventAttributesIdentity <- obj .:? "identity"
    v_activityTaskCompletedEventAttributesWorkerversion <- obj .:? "workerVersion"
    pure (ActivityTaskCompletedEventAttributes {
       activityTaskCompletedEventAttributesResult = v_activityTaskCompletedEventAttributesResult
      , activityTaskCompletedEventAttributesScheduledeventid = v_activityTaskCompletedEventAttributesScheduledeventid
      , activityTaskCompletedEventAttributesStartedeventid = v_activityTaskCompletedEventAttributesStartedeventid
      , activityTaskCompletedEventAttributesIdentity = v_activityTaskCompletedEventAttributesIdentity
      , activityTaskCompletedEventAttributesWorkerversion = v_activityTaskCompletedEventAttributesWorkerversion
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskFailedEventAttributesFailure <- obj .:? "failure"
    v_activityTaskFailedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskFailedEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_activityTaskFailedEventAttributesIdentity <- obj .:? "identity"
    v_activityTaskFailedEventAttributesRetrystate <- obj .:? "retryState"
    v_activityTaskFailedEventAttributesWorkerversion <- obj .:? "workerVersion"
    pure (ActivityTaskFailedEventAttributes {
       activityTaskFailedEventAttributesFailure = v_activityTaskFailedEventAttributesFailure
      , activityTaskFailedEventAttributesScheduledeventid = v_activityTaskFailedEventAttributesScheduledeventid
      , activityTaskFailedEventAttributesStartedeventid = v_activityTaskFailedEventAttributesStartedeventid
      , activityTaskFailedEventAttributesIdentity = v_activityTaskFailedEventAttributesIdentity
      , activityTaskFailedEventAttributesRetrystate = v_activityTaskFailedEventAttributesRetrystate
      , activityTaskFailedEventAttributesWorkerversion = v_activityTaskFailedEventAttributesWorkerversion
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskTimedOutEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskTimedOutEventAttributesFailure <- obj .:? "failure"
    v_activityTaskTimedOutEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskTimedOutEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_activityTaskTimedOutEventAttributesRetrystate <- obj .:? "retryState"
    pure (ActivityTaskTimedOutEventAttributes {
       activityTaskTimedOutEventAttributesFailure = v_activityTaskTimedOutEventAttributesFailure
      , activityTaskTimedOutEventAttributesScheduledeventid = v_activityTaskTimedOutEventAttributesScheduledeventid
      , activityTaskTimedOutEventAttributesStartedeventid = v_activityTaskTimedOutEventAttributesStartedeventid
      , activityTaskTimedOutEventAttributesRetrystate = v_activityTaskTimedOutEventAttributesRetrystate
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskCancelRequestedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskCancelRequestedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskCancelRequestedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    pure (ActivityTaskCancelRequestedEventAttributes {
       activityTaskCancelRequestedEventAttributesScheduledeventid = v_activityTaskCancelRequestedEventAttributesScheduledeventid
      , activityTaskCancelRequestedEventAttributesWorkflowtaskcompletedeventid = v_activityTaskCancelRequestedEventAttributesWorkflowtaskcompletedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityTaskCanceledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityTaskCanceledEventAttributesDetails <- obj .:? "details"
    v_activityTaskCanceledEventAttributesLatestcancelrequestedeventid <- obj .:? "latestCancelRequestedEventId"
    v_activityTaskCanceledEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityTaskCanceledEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_activityTaskCanceledEventAttributesIdentity <- obj .:? "identity"
    v_activityTaskCanceledEventAttributesWorkerversion <- obj .:? "workerVersion"
    pure (ActivityTaskCanceledEventAttributes {
       activityTaskCanceledEventAttributesDetails = v_activityTaskCanceledEventAttributesDetails
      , activityTaskCanceledEventAttributesLatestcancelrequestedeventid = v_activityTaskCanceledEventAttributesLatestcancelrequestedeventid
      , activityTaskCanceledEventAttributesScheduledeventid = v_activityTaskCanceledEventAttributesScheduledeventid
      , activityTaskCanceledEventAttributesStartedeventid = v_activityTaskCanceledEventAttributesStartedeventid
      , activityTaskCanceledEventAttributesIdentity = v_activityTaskCanceledEventAttributesIdentity
      , activityTaskCanceledEventAttributesWorkerversion = v_activityTaskCanceledEventAttributesWorkerversion
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON TimerStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_timerStartedEventAttributesTimerid <- obj .:? "timerId"
    v_timerStartedEventAttributesStarttofiretimeout <- obj .:? "startToFireTimeout"
    v_timerStartedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    pure (TimerStartedEventAttributes {
       timerStartedEventAttributesTimerid = v_timerStartedEventAttributesTimerid
      , timerStartedEventAttributesStarttofiretimeout = v_timerStartedEventAttributesStarttofiretimeout
      , timerStartedEventAttributesWorkflowtaskcompletedeventid = v_timerStartedEventAttributesWorkflowtaskcompletedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON TimerFiredEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_timerFiredEventAttributesTimerid <- obj .:? "timerId"
    v_timerFiredEventAttributesStartedeventid <- obj .:? "startedEventId"
    pure (TimerFiredEventAttributes {
       timerFiredEventAttributesTimerid = v_timerFiredEventAttributesTimerid
      , timerFiredEventAttributesStartedeventid = v_timerFiredEventAttributesStartedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON TimerCanceledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_timerCanceledEventAttributesTimerid <- obj .:? "timerId"
    v_timerCanceledEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_timerCanceledEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_timerCanceledEventAttributesIdentity <- obj .:? "identity"
    pure (TimerCanceledEventAttributes {
       timerCanceledEventAttributesTimerid = v_timerCanceledEventAttributesTimerid
      , timerCanceledEventAttributesStartedeventid = v_timerCanceledEventAttributesStartedeventid
      , timerCanceledEventAttributesWorkflowtaskcompletedeventid = v_timerCanceledEventAttributesWorkflowtaskcompletedeventid
      , timerCanceledEventAttributesIdentity = v_timerCanceledEventAttributesIdentity
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionCancelRequestedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionCancelRequestedEventAttributesCause <- obj .:? "cause"
    v_workflowExecutionCancelRequestedEventAttributesExternalinitiatedeventid <- obj .:? "externalInitiatedEventId"
    v_workflowExecutionCancelRequestedEventAttributesExternalworkflowexecution <- obj .:? "externalWorkflowExecution"
    v_workflowExecutionCancelRequestedEventAttributesIdentity <- obj .:? "identity"
    pure (WorkflowExecutionCancelRequestedEventAttributes {
       workflowExecutionCancelRequestedEventAttributesCause = v_workflowExecutionCancelRequestedEventAttributesCause
      , workflowExecutionCancelRequestedEventAttributesExternalinitiatedeventid = v_workflowExecutionCancelRequestedEventAttributesExternalinitiatedeventid
      , workflowExecutionCancelRequestedEventAttributesExternalworkflowexecution = v_workflowExecutionCancelRequestedEventAttributesExternalworkflowexecution
      , workflowExecutionCancelRequestedEventAttributesIdentity = v_workflowExecutionCancelRequestedEventAttributesIdentity
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionCanceledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionCanceledEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_workflowExecutionCanceledEventAttributesDetails <- obj .:? "details"
    pure (WorkflowExecutionCanceledEventAttributes {
       workflowExecutionCanceledEventAttributesWorkflowtaskcompletedeventid = v_workflowExecutionCanceledEventAttributesWorkflowtaskcompletedeventid
      , workflowExecutionCanceledEventAttributesDetails = v_workflowExecutionCanceledEventAttributesDetails
    })
  protoFromJSON _ = Left "Expected JSON object"
          ...
          Just (Tag fn wt) -> case fn of
            ...
            2 -> do
              ...
              case runDecoder (do
                ...
                Right (k, v) -> loop acc_0 (Map.union acc_1 (Map.singleton k v)) acc_2 acc_3 acc_4
            3 -> do
              v <- fromIntegral <$> decodeFieldVarint
              loop acc_0 acc_1 v acc_3 acc_4
            4 -> do
...
instance ProtoFromJSON MarkerRecordedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_markerRecordedEventAttributesMarkername <- obj .:? "markerName"
    v_markerRecordedEventAttributesDetails <- obj .:? "details"
    v_markerRecordedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_markerRecordedEventAttributesHeader <- obj .:? "header"
    v_markerRecordedEventAttributesFailure <- obj .:? "failure"
    pure (MarkerRecordedEventAttributes {
       markerRecordedEventAttributesMarkername = v_markerRecordedEventAttributesMarkername
      , markerRecordedEventAttributesDetails = v_markerRecordedEventAttributesDetails
      , markerRecordedEventAttributesWorkflowtaskcompletedeventid = v_markerRecordedEventAttributesWorkflowtaskcompletedeventid
      , markerRecordedEventAttributesHeader = v_markerRecordedEventAttributesHeader
      , markerRecordedEventAttributesFailure = v_markerRecordedEventAttributesFailure
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionSignaledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionSignaledEventAttributesSignalname <- obj .:? "signalName"
    v_workflowExecutionSignaledEventAttributesInput <- obj .:? "input"
    v_workflowExecutionSignaledEventAttributesIdentity <- obj .:? "identity"
    v_workflowExecutionSignaledEventAttributesHeader <- obj .:? "header"
    v_workflowExecutionSignaledEventAttributesSkipgenerateworkflowtask <- obj .:? "skipGenerateWorkflowTask"
    v_workflowExecutionSignaledEventAttributesExternalworkflowexecution <- obj .:? "externalWorkflowExecution"
    pure (WorkflowExecutionSignaledEventAttributes {
       workflowExecutionSignaledEventAttributesSignalname = v_workflowExecutionSignaledEventAttributesSignalname
      , workflowExecutionSignaledEventAttributesInput = v_workflowExecutionSignaledEventAttributesInput
      , workflowExecutionSignaledEventAttributesIdentity = v_workflowExecutionSignaledEventAttributesIdentity
      , workflowExecutionSignaledEventAttributesHeader = v_workflowExecutionSignaledEventAttributesHeader
      , workflowExecutionSignaledEventAttributesSkipgenerateworkflowtask = v_workflowExecutionSignaledEventAttributesSkipgenerateworkflowtask
      , workflowExecutionSignaledEventAttributesExternalworkflowexecution = v_workflowExecutionSignaledEventAttributesExternalworkflowexecution
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionTerminatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionTerminatedEventAttributesReason <- obj .:? "reason"
    v_workflowExecutionTerminatedEventAttributesDetails <- obj .:? "details"
    v_workflowExecutionTerminatedEventAttributesIdentity <- obj .:? "identity"
    pure (WorkflowExecutionTerminatedEventAttributes {
       workflowExecutionTerminatedEventAttributesReason = v_workflowExecutionTerminatedEventAttributesReason
      , workflowExecutionTerminatedEventAttributesDetails = v_workflowExecutionTerminatedEventAttributesDetails
      , workflowExecutionTerminatedEventAttributesIdentity = v_workflowExecutionTerminatedEventAttributesIdentity
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON RequestCancelExternalWorkflowExecutionInitiatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespace <- obj .:? "namespace"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesControl <- obj .:? "control"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly <- obj .:? "childWorkflowOnly"
    v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesReason <- obj .:? "reason"
    pure (RequestCancelExternalWorkflowExecutionInitiatedEventAttributes {
       requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespace = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespace
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespaceid = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesNamespaceid
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesControl = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesControl
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly
      , requestCancelExternalWorkflowExecutionInitiatedEventAttributesReason = v_requestCancelExternalWorkflowExecutionInitiatedEventAttributesReason
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON RequestCancelExternalWorkflowExecutionFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesCause <- obj .:? "cause"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesNamespace <- obj .:? "namespace"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_requestCancelExternalWorkflowExecutionFailedEventAttributesControl <- obj .:? "control"
    pure (RequestCancelExternalWorkflowExecutionFailedEventAttributes {
       requestCancelExternalWorkflowExecutionFailedEventAttributesCause = v_requestCancelExternalWorkflowExecutionFailedEventAttributesCause
      , requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid = v_requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid
      , requestCancelExternalWorkflowExecutionFailedEventAttributesNamespace = v_requestCancelExternalWorkflowExecutionFailedEventAttributesNamespace
      , requestCancelExternalWorkflowExecutionFailedEventAttributesNamespaceid = v_requestCancelExternalWorkflowExecutionFailedEventAttributesNamespaceid
      , requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowexecution = v_requestCancelExternalWorkflowExecutionFailedEventAttributesWorkflowexecution
      , requestCancelExternalWorkflowExecutionFailedEventAttributesInitiatedeventid = v_requestCancelExternalWorkflowExecutionFailedEventAttributesInitiatedeventid
      , requestCancelExternalWorkflowExecutionFailedEventAttributesControl = v_requestCancelExternalWorkflowExecutionFailedEventAttributesControl
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ExternalWorkflowExecutionCancelRequestedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_externalWorkflowExecutionCancelRequestedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_externalWorkflowExecutionCancelRequestedEventAttributesNamespace <- obj .:? "namespace"
    v_externalWorkflowExecutionCancelRequestedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_externalWorkflowExecutionCancelRequestedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    pure (ExternalWorkflowExecutionCancelRequestedEventAttributes {
       externalWorkflowExecutionCancelRequestedEventAttributesInitiatedeventid = v_externalWorkflowExecutionCancelRequestedEventAttributesInitiatedeventid
      , externalWorkflowExecutionCancelRequestedEventAttributesNamespace = v_externalWorkflowExecutionCancelRequestedEventAttributesNamespace
      , externalWorkflowExecutionCancelRequestedEventAttributesNamespaceid = v_externalWorkflowExecutionCancelRequestedEventAttributesNamespaceid
      , externalWorkflowExecutionCancelRequestedEventAttributesWorkflowexecution = v_externalWorkflowExecutionCancelRequestedEventAttributesWorkflowexecution
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON SignalExternalWorkflowExecutionInitiatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesNamespace <- obj .:? "namespace"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesSignalname <- obj .:? "signalName"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesInput <- obj .:? "input"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesControl <- obj .:? "control"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly <- obj .:? "childWorkflowOnly"
    v_signalExternalWorkflowExecutionInitiatedEventAttributesHeader <- obj .:? "header"
    pure (SignalExternalWorkflowExecutionInitiatedEventAttributes {
       signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid = v_signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid
      , signalExternalWorkflowExecutionInitiatedEventAttributesNamespace = v_signalExternalWorkflowExecutionInitiatedEventAttributesNamespace
      , signalExternalWorkflowExecutionInitiatedEventAttributesNamespaceid = v_signalExternalWorkflowExecutionInitiatedEventAttributesNamespaceid
      , signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution = v_signalExternalWorkflowExecutionInitiatedEventAttributesWorkflowexecution
      , signalExternalWorkflowExecutionInitiatedEventAttributesSignalname = v_signalExternalWorkflowExecutionInitiatedEventAttributesSignalname
      , signalExternalWorkflowExecutionInitiatedEventAttributesInput = v_signalExternalWorkflowExecutionInitiatedEventAttributesInput
      , signalExternalWorkflowExecutionInitiatedEventAttributesControl = v_signalExternalWorkflowExecutionInitiatedEventAttributesControl
      , signalExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly = v_signalExternalWorkflowExecutionInitiatedEventAttributesChildworkflowonly
      , signalExternalWorkflowExecutionInitiatedEventAttributesHeader = v_signalExternalWorkflowExecutionInitiatedEventAttributesHeader
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON SignalExternalWorkflowExecutionFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_signalExternalWorkflowExecutionFailedEventAttributesCause <- obj .:? "cause"
    v_signalExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_signalExternalWorkflowExecutionFailedEventAttributesNamespace <- obj .:? "namespace"
    v_signalExternalWorkflowExecutionFailedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_signalExternalWorkflowExecutionFailedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_signalExternalWorkflowExecutionFailedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_signalExternalWorkflowExecutionFailedEventAttributesControl <- obj .:? "control"
    pure (SignalExternalWorkflowExecutionFailedEventAttributes {
       signalExternalWorkflowExecutionFailedEventAttributesCause = v_signalExternalWorkflowExecutionFailedEventAttributesCause
      , signalExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid = v_signalExternalWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid
      , signalExternalWorkflowExecutionFailedEventAttributesNamespace = v_signalExternalWorkflowExecutionFailedEventAttributesNamespace
      , signalExternalWorkflowExecutionFailedEventAttributesNamespaceid = v_signalExternalWorkflowExecutionFailedEventAttributesNamespaceid
      , signalExternalWorkflowExecutionFailedEventAttributesWorkflowexecution = v_signalExternalWorkflowExecutionFailedEventAttributesWorkflowexecution
      , signalExternalWorkflowExecutionFailedEventAttributesInitiatedeventid = v_signalExternalWorkflowExecutionFailedEventAttributesInitiatedeventid
      , signalExternalWorkflowExecutionFailedEventAttributesControl = v_signalExternalWorkflowExecutionFailedEventAttributesControl
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ExternalWorkflowExecutionSignaledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_externalWorkflowExecutionSignaledEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_externalWorkflowExecutionSignaledEventAttributesNamespace <- obj .:? "namespace"
    v_externalWorkflowExecutionSignaledEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_externalWorkflowExecutionSignaledEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_externalWorkflowExecutionSignaledEventAttributesControl <- obj .:? "control"
    pure (ExternalWorkflowExecutionSignaledEventAttributes {
       externalWorkflowExecutionSignaledEventAttributesInitiatedeventid = v_externalWorkflowExecutionSignaledEventAttributesInitiatedeventid
      , externalWorkflowExecutionSignaledEventAttributesNamespace = v_externalWorkflowExecutionSignaledEventAttributesNamespace
      , externalWorkflowExecutionSignaledEventAttributesNamespaceid = v_externalWorkflowExecutionSignaledEventAttributesNamespaceid
      , externalWorkflowExecutionSignaledEventAttributesWorkflowexecution = v_externalWorkflowExecutionSignaledEventAttributesWorkflowexecution
      , externalWorkflowExecutionSignaledEventAttributesControl = v_externalWorkflowExecutionSignaledEventAttributesControl
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON UpsertWorkflowSearchAttributesEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_upsertWorkflowSearchAttributesEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_upsertWorkflowSearchAttributesEventAttributesSearchattributes <- obj .:? "searchAttributes"
    pure (UpsertWorkflowSearchAttributesEventAttributes {
       upsertWorkflowSearchAttributesEventAttributesWorkflowtaskcompletedeventid = v_upsertWorkflowSearchAttributesEventAttributesWorkflowtaskcompletedeventid
      , upsertWorkflowSearchAttributesEventAttributesSearchattributes = v_upsertWorkflowSearchAttributesEventAttributesSearchattributes
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowPropertiesModifiedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowPropertiesModifiedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_workflowPropertiesModifiedEventAttributesUpsertedmemo <- obj .:? "upsertedMemo"
    pure (WorkflowPropertiesModifiedEventAttributes {
       workflowPropertiesModifiedEventAttributesWorkflowtaskcompletedeventid = v_workflowPropertiesModifiedEventAttributesWorkflowtaskcompletedeventid
      , workflowPropertiesModifiedEventAttributesUpsertedmemo = v_workflowPropertiesModifiedEventAttributesUpsertedmemo
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON StartChildWorkflowExecutionInitiatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_startChildWorkflowExecutionInitiatedEventAttributesNamespace <- obj .:? "namespace"
    v_startChildWorkflowExecutionInitiatedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowid <- obj .:? "workflowId"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_startChildWorkflowExecutionInitiatedEventAttributesTaskqueue <- obj .:? "taskQueue"
    v_startChildWorkflowExecutionInitiatedEventAttributesInput <- obj .:? "input"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowexecutiontimeout <- obj .:? "workflowExecutionTimeout"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowruntimeout <- obj .:? "workflowRunTimeout"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtasktimeout <- obj .:? "workflowTaskTimeout"
    v_startChildWorkflowExecutionInitiatedEventAttributesParentclosepolicy <- obj .:? "parentClosePolicy"
    v_startChildWorkflowExecutionInitiatedEventAttributesControl <- obj .:? "control"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowidreusepolicy <- obj .:? "workflowIdReusePolicy"
    v_startChildWorkflowExecutionInitiatedEventAttributesRetrypolicy <- obj .:? "retryPolicy"
    v_startChildWorkflowExecutionInitiatedEventAttributesCronschedule <- obj .:? "cronSchedule"
    v_startChildWorkflowExecutionInitiatedEventAttributesHeader <- obj .:? "header"
    v_startChildWorkflowExecutionInitiatedEventAttributesMemo <- obj .:? "memo"
    v_startChildWorkflowExecutionInitiatedEventAttributesSearchattributes <- obj .:? "searchAttributes"
    v_startChildWorkflowExecutionInitiatedEventAttributesInheritbuildid <- obj .:? "inheritBuildId"
    v_startChildWorkflowExecutionInitiatedEventAttributesPriority <- obj .:? "priority"
    pure (StartChildWorkflowExecutionInitiatedEventAttributes {
       startChildWorkflowExecutionInitiatedEventAttributesNamespace = v_startChildWorkflowExecutionInitiatedEventAttributesNamespace
      , startChildWorkflowExecutionInitiatedEventAttributesNamespaceid = v_startChildWorkflowExecutionInitiatedEventAttributesNamespaceid
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowid = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowid
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowtype = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtype
      , startChildWorkflowExecutionInitiatedEventAttributesTaskqueue = v_startChildWorkflowExecutionInitiatedEventAttributesTaskqueue
      , startChildWorkflowExecutionInitiatedEventAttributesInput = v_startChildWorkflowExecutionInitiatedEventAttributesInput
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowexecutiontimeout = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowexecutiontimeout
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowruntimeout = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowruntimeout
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowtasktimeout = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtasktimeout
      , startChildWorkflowExecutionInitiatedEventAttributesParentclosepolicy = v_startChildWorkflowExecutionInitiatedEventAttributesParentclosepolicy
      , startChildWorkflowExecutionInitiatedEventAttributesControl = v_startChildWorkflowExecutionInitiatedEventAttributesControl
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowtaskcompletedeventid
      , startChildWorkflowExecutionInitiatedEventAttributesWorkflowidreusepolicy = v_startChildWorkflowExecutionInitiatedEventAttributesWorkflowidreusepolicy
      , startChildWorkflowExecutionInitiatedEventAttributesRetrypolicy = v_startChildWorkflowExecutionInitiatedEventAttributesRetrypolicy
      , startChildWorkflowExecutionInitiatedEventAttributesCronschedule = v_startChildWorkflowExecutionInitiatedEventAttributesCronschedule
      , startChildWorkflowExecutionInitiatedEventAttributesHeader = v_startChildWorkflowExecutionInitiatedEventAttributesHeader
      , startChildWorkflowExecutionInitiatedEventAttributesMemo = v_startChildWorkflowExecutionInitiatedEventAttributesMemo
      , startChildWorkflowExecutionInitiatedEventAttributesSearchattributes = v_startChildWorkflowExecutionInitiatedEventAttributesSearchattributes
      , startChildWorkflowExecutionInitiatedEventAttributesInheritbuildid = v_startChildWorkflowExecutionInitiatedEventAttributesInheritbuildid
      , startChildWorkflowExecutionInitiatedEventAttributesPriority = v_startChildWorkflowExecutionInitiatedEventAttributesPriority
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON StartChildWorkflowExecutionFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_startChildWorkflowExecutionFailedEventAttributesNamespace <- obj .:? "namespace"
    v_startChildWorkflowExecutionFailedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_startChildWorkflowExecutionFailedEventAttributesWorkflowid <- obj .:? "workflowId"
    v_startChildWorkflowExecutionFailedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_startChildWorkflowExecutionFailedEventAttributesCause <- obj .:? "cause"
    v_startChildWorkflowExecutionFailedEventAttributesControl <- obj .:? "control"
    v_startChildWorkflowExecutionFailedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_startChildWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    pure (StartChildWorkflowExecutionFailedEventAttributes {
       startChildWorkflowExecutionFailedEventAttributesNamespace = v_startChildWorkflowExecutionFailedEventAttributesNamespace
      , startChildWorkflowExecutionFailedEventAttributesNamespaceid = v_startChildWorkflowExecutionFailedEventAttributesNamespaceid
      , startChildWorkflowExecutionFailedEventAttributesWorkflowid = v_startChildWorkflowExecutionFailedEventAttributesWorkflowid
      , startChildWorkflowExecutionFailedEventAttributesWorkflowtype = v_startChildWorkflowExecutionFailedEventAttributesWorkflowtype
      , startChildWorkflowExecutionFailedEventAttributesCause = v_startChildWorkflowExecutionFailedEventAttributesCause
      , startChildWorkflowExecutionFailedEventAttributesControl = v_startChildWorkflowExecutionFailedEventAttributesControl
      , startChildWorkflowExecutionFailedEventAttributesInitiatedeventid = v_startChildWorkflowExecutionFailedEventAttributesInitiatedeventid
      , startChildWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid = v_startChildWorkflowExecutionFailedEventAttributesWorkflowtaskcompletedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionStartedEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionStartedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionStartedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionStartedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionStartedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionStartedEventAttributesHeader <- obj .:? "header"
    pure (ChildWorkflowExecutionStartedEventAttributes {
       childWorkflowExecutionStartedEventAttributesNamespace = v_childWorkflowExecutionStartedEventAttributesNamespace
      , childWorkflowExecutionStartedEventAttributesNamespaceid = v_childWorkflowExecutionStartedEventAttributesNamespaceid
      , childWorkflowExecutionStartedEventAttributesInitiatedeventid = v_childWorkflowExecutionStartedEventAttributesInitiatedeventid
      , childWorkflowExecutionStartedEventAttributesWorkflowexecution = v_childWorkflowExecutionStartedEventAttributesWorkflowexecution
      , childWorkflowExecutionStartedEventAttributesWorkflowtype = v_childWorkflowExecutionStartedEventAttributesWorkflowtype
      , childWorkflowExecutionStartedEventAttributesHeader = v_childWorkflowExecutionStartedEventAttributesHeader
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionCompletedEventAttributesResult <- obj .:? "result"
    v_childWorkflowExecutionCompletedEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionCompletedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionCompletedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionCompletedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionCompletedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionCompletedEventAttributesStartedeventid <- obj .:? "startedEventId"
    pure (ChildWorkflowExecutionCompletedEventAttributes {
       childWorkflowExecutionCompletedEventAttributesResult = v_childWorkflowExecutionCompletedEventAttributesResult
      , childWorkflowExecutionCompletedEventAttributesNamespace = v_childWorkflowExecutionCompletedEventAttributesNamespace
      , childWorkflowExecutionCompletedEventAttributesNamespaceid = v_childWorkflowExecutionCompletedEventAttributesNamespaceid
      , childWorkflowExecutionCompletedEventAttributesWorkflowexecution = v_childWorkflowExecutionCompletedEventAttributesWorkflowexecution
      , childWorkflowExecutionCompletedEventAttributesWorkflowtype = v_childWorkflowExecutionCompletedEventAttributesWorkflowtype
      , childWorkflowExecutionCompletedEventAttributesInitiatedeventid = v_childWorkflowExecutionCompletedEventAttributesInitiatedeventid
      , childWorkflowExecutionCompletedEventAttributesStartedeventid = v_childWorkflowExecutionCompletedEventAttributesStartedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionFailedEventAttributesFailure <- obj .:? "failure"
    v_childWorkflowExecutionFailedEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionFailedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionFailedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionFailedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionFailedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionFailedEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_childWorkflowExecutionFailedEventAttributesRetrystate <- obj .:? "retryState"
    pure (ChildWorkflowExecutionFailedEventAttributes {
       childWorkflowExecutionFailedEventAttributesFailure = v_childWorkflowExecutionFailedEventAttributesFailure
      , childWorkflowExecutionFailedEventAttributesNamespace = v_childWorkflowExecutionFailedEventAttributesNamespace
      , childWorkflowExecutionFailedEventAttributesNamespaceid = v_childWorkflowExecutionFailedEventAttributesNamespaceid
      , childWorkflowExecutionFailedEventAttributesWorkflowexecution = v_childWorkflowExecutionFailedEventAttributesWorkflowexecution
      , childWorkflowExecutionFailedEventAttributesWorkflowtype = v_childWorkflowExecutionFailedEventAttributesWorkflowtype
      , childWorkflowExecutionFailedEventAttributesInitiatedeventid = v_childWorkflowExecutionFailedEventAttributesInitiatedeventid
      , childWorkflowExecutionFailedEventAttributesStartedeventid = v_childWorkflowExecutionFailedEventAttributesStartedeventid
      , childWorkflowExecutionFailedEventAttributesRetrystate = v_childWorkflowExecutionFailedEventAttributesRetrystate
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionCanceledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionCanceledEventAttributesDetails <- obj .:? "details"
    v_childWorkflowExecutionCanceledEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionCanceledEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionCanceledEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionCanceledEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionCanceledEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionCanceledEventAttributesStartedeventid <- obj .:? "startedEventId"
    pure (ChildWorkflowExecutionCanceledEventAttributes {
       childWorkflowExecutionCanceledEventAttributesDetails = v_childWorkflowExecutionCanceledEventAttributesDetails
      , childWorkflowExecutionCanceledEventAttributesNamespace = v_childWorkflowExecutionCanceledEventAttributesNamespace
      , childWorkflowExecutionCanceledEventAttributesNamespaceid = v_childWorkflowExecutionCanceledEventAttributesNamespaceid
      , childWorkflowExecutionCanceledEventAttributesWorkflowexecution = v_childWorkflowExecutionCanceledEventAttributesWorkflowexecution
      , childWorkflowExecutionCanceledEventAttributesWorkflowtype = v_childWorkflowExecutionCanceledEventAttributesWorkflowtype
      , childWorkflowExecutionCanceledEventAttributesInitiatedeventid = v_childWorkflowExecutionCanceledEventAttributesInitiatedeventid
      , childWorkflowExecutionCanceledEventAttributesStartedeventid = v_childWorkflowExecutionCanceledEventAttributesStartedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionTimedOutEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionTimedOutEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionTimedOutEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionTimedOutEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionTimedOutEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionTimedOutEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionTimedOutEventAttributesStartedeventid <- obj .:? "startedEventId"
    v_childWorkflowExecutionTimedOutEventAttributesRetrystate <- obj .:? "retryState"
    pure (ChildWorkflowExecutionTimedOutEventAttributes {
       childWorkflowExecutionTimedOutEventAttributesNamespace = v_childWorkflowExecutionTimedOutEventAttributesNamespace
      , childWorkflowExecutionTimedOutEventAttributesNamespaceid = v_childWorkflowExecutionTimedOutEventAttributesNamespaceid
      , childWorkflowExecutionTimedOutEventAttributesWorkflowexecution = v_childWorkflowExecutionTimedOutEventAttributesWorkflowexecution
      , childWorkflowExecutionTimedOutEventAttributesWorkflowtype = v_childWorkflowExecutionTimedOutEventAttributesWorkflowtype
      , childWorkflowExecutionTimedOutEventAttributesInitiatedeventid = v_childWorkflowExecutionTimedOutEventAttributesInitiatedeventid
      , childWorkflowExecutionTimedOutEventAttributesStartedeventid = v_childWorkflowExecutionTimedOutEventAttributesStartedeventid
      , childWorkflowExecutionTimedOutEventAttributesRetrystate = v_childWorkflowExecutionTimedOutEventAttributesRetrystate
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ChildWorkflowExecutionTerminatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_childWorkflowExecutionTerminatedEventAttributesNamespace <- obj .:? "namespace"
    v_childWorkflowExecutionTerminatedEventAttributesNamespaceid <- obj .:? "namespaceId"
    v_childWorkflowExecutionTerminatedEventAttributesWorkflowexecution <- obj .:? "workflowExecution"
    v_childWorkflowExecutionTerminatedEventAttributesWorkflowtype <- obj .:? "workflowType"
    v_childWorkflowExecutionTerminatedEventAttributesInitiatedeventid <- obj .:? "initiatedEventId"
    v_childWorkflowExecutionTerminatedEventAttributesStartedeventid <- obj .:? "startedEventId"
    pure (ChildWorkflowExecutionTerminatedEventAttributes {
       childWorkflowExecutionTerminatedEventAttributesNamespace = v_childWorkflowExecutionTerminatedEventAttributesNamespace
      , childWorkflowExecutionTerminatedEventAttributesNamespaceid = v_childWorkflowExecutionTerminatedEventAttributesNamespaceid
      , childWorkflowExecutionTerminatedEventAttributesWorkflowexecution = v_childWorkflowExecutionTerminatedEventAttributesWorkflowexecution
      , childWorkflowExecutionTerminatedEventAttributesWorkflowtype = v_childWorkflowExecutionTerminatedEventAttributesWorkflowtype
      , childWorkflowExecutionTerminatedEventAttributesInitiatedeventid = v_childWorkflowExecutionTerminatedEventAttributesInitiatedeventid
      , childWorkflowExecutionTerminatedEventAttributesStartedeventid = v_childWorkflowExecutionTerminatedEventAttributesStartedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionOptionsUpdatedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionOptionsUpdatedEventAttributesVersioningoverride <- obj .:? "versioningOverride"
    v_workflowExecutionOptionsUpdatedEventAttributesUnsetversioningoverride <- obj .:? "unsetVersioningOverride"
    v_workflowExecutionOptionsUpdatedEventAttributesAttachedrequestid <- obj .:? "attachedRequestId"
    v_workflowExecutionOptionsUpdatedEventAttributesAttachedcompletioncallbacks <- obj .:? "attachedCompletionCallbacks"
    v_workflowExecutionOptionsUpdatedEventAttributesIdentity <- obj .:? "identity"
    v_workflowExecutionOptionsUpdatedEventAttributesPriority <- obj .:? "priority"
    pure (WorkflowExecutionOptionsUpdatedEventAttributes {
       workflowExecutionOptionsUpdatedEventAttributesVersioningoverride = v_workflowExecutionOptionsUpdatedEventAttributesVersioningoverride
      , workflowExecutionOptionsUpdatedEventAttributesUnsetversioningoverride = v_workflowExecutionOptionsUpdatedEventAttributesUnsetversioningoverride
      , workflowExecutionOptionsUpdatedEventAttributesAttachedrequestid = v_workflowExecutionOptionsUpdatedEventAttributesAttachedrequestid
      , workflowExecutionOptionsUpdatedEventAttributesAttachedcompletioncallbacks = v_workflowExecutionOptionsUpdatedEventAttributesAttachedcompletioncallbacks
      , workflowExecutionOptionsUpdatedEventAttributesIdentity = v_workflowExecutionOptionsUpdatedEventAttributesIdentity
      , workflowExecutionOptionsUpdatedEventAttributesPriority = v_workflowExecutionOptionsUpdatedEventAttributesPriority
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowPropertiesModifiedExternallyEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowPropertiesModifiedExternallyEventAttributesNewtaskqueue <- obj .:? "newTaskQueue"
    v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowtasktimeout <- obj .:? "newWorkflowTaskTimeout"
    v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowruntimeout <- obj .:? "newWorkflowRunTimeout"
    v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowexecutiontimeout <- obj .:? "newWorkflowExecutionTimeout"
    v_workflowPropertiesModifiedExternallyEventAttributesUpsertedmemo <- obj .:? "upsertedMemo"
    pure (WorkflowPropertiesModifiedExternallyEventAttributes {
       workflowPropertiesModifiedExternallyEventAttributesNewtaskqueue = v_workflowPropertiesModifiedExternallyEventAttributesNewtaskqueue
      , workflowPropertiesModifiedExternallyEventAttributesNewworkflowtasktimeout = v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowtasktimeout
      , workflowPropertiesModifiedExternallyEventAttributesNewworkflowruntimeout = v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowruntimeout
      , workflowPropertiesModifiedExternallyEventAttributesNewworkflowexecutiontimeout = v_workflowPropertiesModifiedExternallyEventAttributesNewworkflowexecutiontimeout
      , workflowPropertiesModifiedExternallyEventAttributesUpsertedmemo = v_workflowPropertiesModifiedExternallyEventAttributesUpsertedmemo
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON ActivityPropertiesModifiedExternallyEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_activityPropertiesModifiedExternallyEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_activityPropertiesModifiedExternallyEventAttributesNewretrypolicy <- obj .:? "newRetryPolicy"
    pure (ActivityPropertiesModifiedExternallyEventAttributes {
       activityPropertiesModifiedExternallyEventAttributesScheduledeventid = v_activityPropertiesModifiedExternallyEventAttributesScheduledeventid
      , activityPropertiesModifiedExternallyEventAttributesNewretrypolicy = v_activityPropertiesModifiedExternallyEventAttributesNewretrypolicy
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionUpdateAcceptedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionUpdateAcceptedEventAttributesProtocolinstanceid <- obj .:? "protocolInstanceId"
    v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestmessageid <- obj .:? "acceptedRequestMessageId"
    v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestsequencingeventid <- obj .:? "acceptedRequestSequencingEventId"
    v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequest <- obj .:? "acceptedRequest"
    pure (WorkflowExecutionUpdateAcceptedEventAttributes {
       workflowExecutionUpdateAcceptedEventAttributesProtocolinstanceid = v_workflowExecutionUpdateAcceptedEventAttributesProtocolinstanceid
      , workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestmessageid = v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestmessageid
      , workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestsequencingeventid = v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequestsequencingeventid
      , workflowExecutionUpdateAcceptedEventAttributesAcceptedrequest = v_workflowExecutionUpdateAcceptedEventAttributesAcceptedrequest
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionUpdateCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionUpdateCompletedEventAttributesMeta <- obj .:? "meta"
    v_workflowExecutionUpdateCompletedEventAttributesAcceptedeventid <- obj .:? "acceptedEventId"
    v_workflowExecutionUpdateCompletedEventAttributesOutcome <- obj .:? "outcome"
    pure (WorkflowExecutionUpdateCompletedEventAttributes {
       workflowExecutionUpdateCompletedEventAttributesMeta = v_workflowExecutionUpdateCompletedEventAttributesMeta
      , workflowExecutionUpdateCompletedEventAttributesAcceptedeventid = v_workflowExecutionUpdateCompletedEventAttributesAcceptedeventid
      , workflowExecutionUpdateCompletedEventAttributesOutcome = v_workflowExecutionUpdateCompletedEventAttributesOutcome
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionUpdateRejectedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionUpdateRejectedEventAttributesProtocolinstanceid <- obj .:? "protocolInstanceId"
    v_workflowExecutionUpdateRejectedEventAttributesRejectedrequestmessageid <- obj .:? "rejectedRequestMessageId"
    v_workflowExecutionUpdateRejectedEventAttributesRejectedrequestsequencingeventid <- obj .:? "rejectedRequestSequencingEventId"
    v_workflowExecutionUpdateRejectedEventAttributesRejectedrequest <- obj .:? "rejectedRequest"
    v_workflowExecutionUpdateRejectedEventAttributesFailure <- obj .:? "failure"
    pure (WorkflowExecutionUpdateRejectedEventAttributes {
       workflowExecutionUpdateRejectedEventAttributesProtocolinstanceid = v_workflowExecutionUpdateRejectedEventAttributesProtocolinstanceid
      , workflowExecutionUpdateRejectedEventAttributesRejectedrequestmessageid = v_workflowExecutionUpdateRejectedEventAttributesRejectedrequestmessageid
      , workflowExecutionUpdateRejectedEventAttributesRejectedrequestsequencingeventid = v_workflowExecutionUpdateRejectedEventAttributesRejectedrequestsequencingeventid
      , workflowExecutionUpdateRejectedEventAttributesRejectedrequest = v_workflowExecutionUpdateRejectedEventAttributesRejectedrequest
      , workflowExecutionUpdateRejectedEventAttributesFailure = v_workflowExecutionUpdateRejectedEventAttributesFailure
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionUpdateAdmittedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionUpdateAdmittedEventAttributesRequest <- obj .:? "request"
    v_workflowExecutionUpdateAdmittedEventAttributesOrigin <- obj .:? "origin"
    pure (WorkflowExecutionUpdateAdmittedEventAttributes {
       workflowExecutionUpdateAdmittedEventAttributesRequest = v_workflowExecutionUpdateAdmittedEventAttributesRequest
      , workflowExecutionUpdateAdmittedEventAttributesOrigin = v_workflowExecutionUpdateAdmittedEventAttributesOrigin
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionPausedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionPausedEventAttributesIdentity <- obj .:? "identity"
    v_workflowExecutionPausedEventAttributesReason <- obj .:? "reason"
    v_workflowExecutionPausedEventAttributesRequestid <- obj .:? "requestId"
    pure (WorkflowExecutionPausedEventAttributes {
       workflowExecutionPausedEventAttributesIdentity = v_workflowExecutionPausedEventAttributesIdentity
      , workflowExecutionPausedEventAttributesReason = v_workflowExecutionPausedEventAttributesReason
      , workflowExecutionPausedEventAttributesRequestid = v_workflowExecutionPausedEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON WorkflowExecutionUnpausedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_workflowExecutionUnpausedEventAttributesIdentity <- obj .:? "identity"
    v_workflowExecutionUnpausedEventAttributesReason <- obj .:? "reason"
    v_workflowExecutionUnpausedEventAttributesRequestid <- obj .:? "requestId"
    pure (WorkflowExecutionUnpausedEventAttributes {
       workflowExecutionUnpausedEventAttributesIdentity = v_workflowExecutionUnpausedEventAttributesIdentity
      , workflowExecutionUnpausedEventAttributesReason = v_workflowExecutionUnpausedEventAttributesReason
      , workflowExecutionUnpausedEventAttributesRequestid = v_workflowExecutionUnpausedEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
          ...
          Just (Tag fn wt) -> case fn of
            ...
            6 -> do
              ...
              case runDecoder (do
                ...
                Right (k, v) -> loop acc_0 acc_1 acc_2 acc_3 acc_4 (Map.union acc_5 (Map.singleton k v)) acc_6 acc_7 acc_8 acc_9 acc_10
            7 -> do
              v <- fromIntegral <$> decodeFieldVarint
...
instance ProtoFromJSON NexusOperationScheduledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationScheduledEventAttributesEndpoint <- obj .:? "endpoint"
    v_nexusOperationScheduledEventAttributesService <- obj .:? "service"
    v_nexusOperationScheduledEventAttributesOperation <- obj .:? "operation"
    v_nexusOperationScheduledEventAttributesInput <- obj .:? "input"
    v_nexusOperationScheduledEventAttributesScheduletoclosetimeout <- obj .:? "scheduleToCloseTimeout"
    v_nexusOperationScheduledEventAttributesNexusheader <- obj .:? "nexusHeader"
    v_nexusOperationScheduledEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_nexusOperationScheduledEventAttributesRequestid <- obj .:? "requestId"
    v_nexusOperationScheduledEventAttributesEndpointid <- obj .:? "endpointId"
    v_nexusOperationScheduledEventAttributesScheduletostarttimeout <- obj .:? "scheduleToStartTimeout"
    v_nexusOperationScheduledEventAttributesStarttoclosetimeout <- obj .:? "startToCloseTimeout"
    pure (NexusOperationScheduledEventAttributes {
       nexusOperationScheduledEventAttributesEndpoint = v_nexusOperationScheduledEventAttributesEndpoint
      , nexusOperationScheduledEventAttributesService = v_nexusOperationScheduledEventAttributesService
      , nexusOperationScheduledEventAttributesOperation = v_nexusOperationScheduledEventAttributesOperation
      , nexusOperationScheduledEventAttributesInput = v_nexusOperationScheduledEventAttributesInput
      , nexusOperationScheduledEventAttributesScheduletoclosetimeout = v_nexusOperationScheduledEventAttributesScheduletoclosetimeout
      , nexusOperationScheduledEventAttributesNexusheader = v_nexusOperationScheduledEventAttributesNexusheader
      , nexusOperationScheduledEventAttributesWorkflowtaskcompletedeventid = v_nexusOperationScheduledEventAttributesWorkflowtaskcompletedeventid
      , nexusOperationScheduledEventAttributesRequestid = v_nexusOperationScheduledEventAttributesRequestid
      , nexusOperationScheduledEventAttributesEndpointid = v_nexusOperationScheduledEventAttributesEndpointid
      , nexusOperationScheduledEventAttributesScheduletostarttimeout = v_nexusOperationScheduledEventAttributesScheduletostarttimeout
      , nexusOperationScheduledEventAttributesStarttoclosetimeout = v_nexusOperationScheduledEventAttributesStarttoclosetimeout
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationStartedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationStartedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationStartedEventAttributesOperationid <- obj .:? "operationId"
    v_nexusOperationStartedEventAttributesRequestid <- obj .:? "requestId"
    v_nexusOperationStartedEventAttributesOperationtoken <- obj .:? "operationToken"
    pure (NexusOperationStartedEventAttributes {
       nexusOperationStartedEventAttributesScheduledeventid = v_nexusOperationStartedEventAttributesScheduledeventid
      , nexusOperationStartedEventAttributesOperationid = v_nexusOperationStartedEventAttributesOperationid
      , nexusOperationStartedEventAttributesRequestid = v_nexusOperationStartedEventAttributesRequestid
      , nexusOperationStartedEventAttributesOperationtoken = v_nexusOperationStartedEventAttributesOperationtoken
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationCompletedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationCompletedEventAttributesResult <- obj .:? "result"
    v_nexusOperationCompletedEventAttributesRequestid <- obj .:? "requestId"
    pure (NexusOperationCompletedEventAttributes {
       nexusOperationCompletedEventAttributesScheduledeventid = v_nexusOperationCompletedEventAttributesScheduledeventid
      , nexusOperationCompletedEventAttributesResult = v_nexusOperationCompletedEventAttributesResult
      , nexusOperationCompletedEventAttributesRequestid = v_nexusOperationCompletedEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationFailedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationFailedEventAttributesFailure <- obj .:? "failure"
    v_nexusOperationFailedEventAttributesRequestid <- obj .:? "requestId"
    pure (NexusOperationFailedEventAttributes {
       nexusOperationFailedEventAttributesScheduledeventid = v_nexusOperationFailedEventAttributesScheduledeventid
      , nexusOperationFailedEventAttributesFailure = v_nexusOperationFailedEventAttributesFailure
      , nexusOperationFailedEventAttributesRequestid = v_nexusOperationFailedEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationTimedOutEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationTimedOutEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationTimedOutEventAttributesFailure <- obj .:? "failure"
    v_nexusOperationTimedOutEventAttributesRequestid <- obj .:? "requestId"
    pure (NexusOperationTimedOutEventAttributes {
       nexusOperationTimedOutEventAttributesScheduledeventid = v_nexusOperationTimedOutEventAttributesScheduledeventid
      , nexusOperationTimedOutEventAttributesFailure = v_nexusOperationTimedOutEventAttributesFailure
      , nexusOperationTimedOutEventAttributesRequestid = v_nexusOperationTimedOutEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationCanceledEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationCanceledEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationCanceledEventAttributesFailure <- obj .:? "failure"
    v_nexusOperationCanceledEventAttributesRequestid <- obj .:? "requestId"
    pure (NexusOperationCanceledEventAttributes {
       nexusOperationCanceledEventAttributesScheduledeventid = v_nexusOperationCanceledEventAttributesScheduledeventid
      , nexusOperationCanceledEventAttributesFailure = v_nexusOperationCanceledEventAttributesFailure
      , nexusOperationCanceledEventAttributesRequestid = v_nexusOperationCanceledEventAttributesRequestid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationCancelRequestedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationCancelRequestedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    v_nexusOperationCancelRequestedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    pure (NexusOperationCancelRequestedEventAttributes {
       nexusOperationCancelRequestedEventAttributesScheduledeventid = v_nexusOperationCancelRequestedEventAttributesScheduledeventid
      , nexusOperationCancelRequestedEventAttributesWorkflowtaskcompletedeventid = v_nexusOperationCancelRequestedEventAttributesWorkflowtaskcompletedeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationCancelRequestCompletedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationCancelRequestCompletedEventAttributesRequestedeventid <- obj .:? "requestedEventId"
    v_nexusOperationCancelRequestCompletedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_nexusOperationCancelRequestCompletedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    pure (NexusOperationCancelRequestCompletedEventAttributes {
       nexusOperationCancelRequestCompletedEventAttributesRequestedeventid = v_nexusOperationCancelRequestCompletedEventAttributesRequestedeventid
      , nexusOperationCancelRequestCompletedEventAttributesWorkflowtaskcompletedeventid = v_nexusOperationCancelRequestCompletedEventAttributesWorkflowtaskcompletedeventid
      , nexusOperationCancelRequestCompletedEventAttributesScheduledeventid = v_nexusOperationCancelRequestCompletedEventAttributesScheduledeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON NexusOperationCancelRequestFailedEventAttributes where
  protoFromJSON (JsonObject obj) = do
    v_nexusOperationCancelRequestFailedEventAttributesRequestedeventid <- obj .:? "requestedEventId"
    v_nexusOperationCancelRequestFailedEventAttributesWorkflowtaskcompletedeventid <- obj .:? "workflowTaskCompletedEventId"
    v_nexusOperationCancelRequestFailedEventAttributesFailure <- obj .:? "failure"
    v_nexusOperationCancelRequestFailedEventAttributesScheduledeventid <- obj .:? "scheduledEventId"
    pure (NexusOperationCancelRequestFailedEventAttributes {
       nexusOperationCancelRequestFailedEventAttributesRequestedeventid = v_nexusOperationCancelRequestFailedEventAttributesRequestedeventid
      , nexusOperationCancelRequestFailedEventAttributesWorkflowtaskcompletedeventid = v_nexusOperationCancelRequestFailedEventAttributesWorkflowtaskcompletedeventid
      , nexusOperationCancelRequestFailedEventAttributesFailure = v_nexusOperationCancelRequestFailedEventAttributesFailure
      , nexusOperationCancelRequestFailedEventAttributesScheduledeventid = v_nexusOperationCancelRequestFailedEventAttributesScheduledeventid
    })
  protoFromJSON _ = Left "Expected JSON object"
...
data HistoryEvent'Attributes
  ...
  | HistoryEvent'WorkflowExecutionPausedEventAttributes !WorkflowExecutionPausedEventAttributes
  | HistoryEvent'WorkflowExecutionUnpausedEventAttributes !WorkflowExecutionUnpausedEventAttributes
  deriving stock (Show, Eq, Generic)
  deriving anyclass NFData
...
instance MessageEncode HistoryEvent where
  buildMessage msg =
    ...
    <> (case msg.historyEventAttributes of
      Nothing -> mempty
      Just (HistoryEvent'WorkflowExecutionStartedEventAttributes v) -> encodeFieldMessage 6 v
      Just (HistoryEvent'WorkflowExecutionCompletedEventAttributes v) -> encodeFieldMessage 7 v
      Just (HistoryEvent'WorkflowExecutionFailedEventAttributes v) -> encodeFieldMessage 8 v
      Just (HistoryEvent'WorkflowExecutionTimedOutEventAttributes v) -> encodeFieldMessage 9 v
      Just (HistoryEvent'WorkflowTaskScheduledEventAttributes v) -> encodeFieldMessage 10 v
      Just (HistoryEvent'WorkflowTaskStartedEventAttributes v) -> encodeFieldMessage 11 v
      Just (HistoryEvent'WorkflowTaskCompletedEventAttributes v) -> encodeFieldMessage 12 v
      Just (HistoryEvent'WorkflowTaskTimedOutEventAttributes v) -> encodeFieldMessage 13 v
      Just (HistoryEvent'WorkflowTaskFailedEventAttributes v) -> encodeFieldMessage 14 v
      Just (HistoryEvent'ActivityTaskScheduledEventAttributes v) -> encodeFieldMessage 15 v
      Just (HistoryEvent'ActivityTaskStartedEventAttributes v) -> encodeFieldMessage 16 v
      Just (HistoryEvent'ActivityTaskCompletedEventAttributes v) -> encodeFieldMessage 17 v
      Just (HistoryEvent'ActivityTaskFailedEventAttributes v) -> encodeFieldMessage 18 v
      Just (HistoryEvent'ActivityTaskTimedOutEventAttributes v) -> encodeFieldMessage 19 v
      Just (HistoryEvent'TimerStartedEventAttributes v) -> encodeFieldMessage 20 v
      Just (HistoryEvent'TimerFiredEventAttributes v) -> encodeFieldMessage 21 v
      Just (HistoryEvent'ActivityTaskCancelRequestedEventAttributes v) -> encodeFieldMessage 22 v
      Just (HistoryEvent'ActivityTaskCanceledEventAttributes v) -> encodeFieldMessage 23 v
      Just (HistoryEvent'TimerCanceledEventAttributes v) -> encodeFieldMessage 24 v
      Just (HistoryEvent'MarkerRecordedEventAttributes v) -> encodeFieldMessage 25 v
      Just (HistoryEvent'WorkflowExecutionSignaledEventAttributes v) -> encodeFieldMessage 26 v
      Just (HistoryEvent'WorkflowExecutionTerminatedEventAttributes v) -> encodeFieldMessage 27 v
      Just (HistoryEvent'WorkflowExecutionCancelRequestedEventAttributes v) -> encodeFieldMessage 28 v
      Just (HistoryEvent'WorkflowExecutionCanceledEventAttributes v) -> encodeFieldMessage 29 v
      Just (HistoryEvent'RequestCancelExternalWorkflowExecutionInitiatedEventAttributes v) -> encodeFieldMessage 30 v
      Just (HistoryEvent'RequestCancelExternalWorkflowExecutionFailedEventAttributes v) -> encodeFieldMessage 31 v
      Just (HistoryEvent'ExternalWorkflowExecutionCancelRequestedEventAttributes v) -> encodeFieldMessage 32 v
      Just (HistoryEvent'WorkflowExecutionContinuedAsNewEventAttributes v) -> encodeFieldMessage 33 v
      Just (HistoryEvent'StartChildWorkflowExecutionInitiatedEventAttributes v) -> encodeFieldMessage 34 v
      Just (HistoryEvent'StartChildWorkflowExecutionFailedEventAttributes v) -> encodeFieldMessage 35 v
      Just (HistoryEvent'ChildWorkflowExecutionStartedEventAttributes v) -> encodeFieldMessage 36 v
      Just (HistoryEvent'ChildWorkflowExecutionCompletedEventAttributes v) -> encodeFieldMessage 37 v
      Just (HistoryEvent'ChildWorkflowExecutionFailedEventAttributes v) -> encodeFieldMessage 38 v
      Just (HistoryEvent'ChildWorkflowExecutionCanceledEventAttributes v) -> encodeFieldMessage 39 v
      Just (HistoryEvent'ChildWorkflowExecutionTimedOutEventAttributes v) -> encodeFieldMessage 40 v
      Just (HistoryEvent'ChildWorkflowExecutionTerminatedEventAttributes v) -> encodeFieldMessage 41 v
      Just (HistoryEvent'SignalExternalWorkflowExecutionInitiatedEventAttributes v) -> encodeFieldMessage 42 v
      Just (HistoryEvent'SignalExternalWorkflowExecutionFailedEventAttributes v) -> encodeFieldMessage 43 v
      Just (HistoryEvent'ExternalWorkflowExecutionSignaledEventAttributes v) -> encodeFieldMessage 44 v
      Just (HistoryEvent'UpsertWorkflowSearchAttributesEventAttributes v) -> encodeFieldMessage 45 v
      Just (HistoryEvent'WorkflowExecutionUpdateAcceptedEventAttributes v) -> encodeFieldMessage 46 v
      Just (HistoryEvent'WorkflowExecutionUpdateRejectedEventAttributes v) -> encodeFieldMessage 47 v
      Just (HistoryEvent'WorkflowExecutionUpdateCompletedEventAttributes v) -> encodeFieldMessage 48 v
      Just (HistoryEvent'WorkflowPropertiesModifiedExternallyEventAttributes v) -> encodeFieldMessage 49 v
      Just (HistoryEvent'ActivityPropertiesModifiedExternallyEventAttributes v) -> encodeFieldMessage 50 v
      Just (HistoryEvent'WorkflowPropertiesModifiedEventAttributes v) -> encodeFieldMessage 51 v
      Just (HistoryEvent'WorkflowExecutionUpdateAdmittedEventAttributes v) -> encodeFieldMessage 52 v
      Just (HistoryEvent'NexusOperationScheduledEventAttributes v) -> encodeFieldMessage 53 v
      Just (HistoryEvent'NexusOperationStartedEventAttributes v) -> encodeFieldMessage 54 v
      Just (HistoryEvent'NexusOperationCompletedEventAttributes v) -> encodeFieldMessage 55 v
      Just (HistoryEvent'NexusOperationFailedEventAttributes v) -> encodeFieldMessage 56 v
      Just (HistoryEvent'NexusOperationCanceledEventAttributes v) -> encodeFieldMessage 57 v
      Just (HistoryEvent'NexusOperationTimedOutEventAttributes v) -> encodeFieldMessage 58 v
      Just (HistoryEvent'NexusOperationCancelRequestedEventAttributes v) -> encodeFieldMessage 59 v
      Just (HistoryEvent'WorkflowExecutionOptionsUpdatedEventAttributes v) -> encodeFieldMessage 60 v
      Just (HistoryEvent'NexusOperationCancelRequestCompletedEventAttributes v) -> encodeFieldMessage 61 v
      Just (HistoryEvent'NexusOperationCancelRequestFailedEventAttributes v) -> encodeFieldMessage 62 v
      Just (HistoryEvent'WorkflowExecutionPausedEventAttributes v) -> encodeFieldMessage 63 v
      Just (HistoryEvent'WorkflowExecutionUnpausedEventAttributes v) -> encodeFieldMessage 64 v)
...
instance MessageSize HistoryEvent where
  messageSize msg =
    ...
    + (case msg.historyEventAttributes of { Nothing -> 0; Just (HistoryEvent'WorkflowExecutionStartedEventAttributes v) -> fieldMessageSize 6 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionCompletedEventAttributes v) -> fieldMessageSize 7 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionFailedEventAttributes v) -> fieldMessageSize 8 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionTimedOutEventAttributes v) -> fieldMessageSize 9 (messageSize v)
    ; Just (HistoryEvent'WorkflowTaskScheduledEventAttributes v) -> fieldMessageSize 10 (messageSize v)
    ; Just (HistoryEvent'WorkflowTaskStartedEventAttributes v) -> fieldMessageSize 11 (messageSize v)
    ; Just (HistoryEvent'WorkflowTaskCompletedEventAttributes v) -> fieldMessageSize 12 (messageSize v)
    ; Just (HistoryEvent'WorkflowTaskTimedOutEventAttributes v) -> fieldMessageSize 13 (messageSize v)
    ; Just (HistoryEvent'WorkflowTaskFailedEventAttributes v) -> fieldMessageSize 14 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskScheduledEventAttributes v) -> fieldMessageSize 15 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskStartedEventAttributes v) -> fieldMessageSize 16 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskCompletedEventAttributes v) -> fieldMessageSize 17 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskFailedEventAttributes v) -> fieldMessageSize 18 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskTimedOutEventAttributes v) -> fieldMessageSize 19 (messageSize v)
    ; Just (HistoryEvent'TimerStartedEventAttributes v) -> fieldMessageSize 20 (messageSize v)
    ; Just (HistoryEvent'TimerFiredEventAttributes v) -> fieldMessageSize 21 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskCancelRequestedEventAttributes v) -> fieldMessageSize 22 (messageSize v)
    ; Just (HistoryEvent'ActivityTaskCanceledEventAttributes v) -> fieldMessageSize 23 (messageSize v)
    ; Just (HistoryEvent'TimerCanceledEventAttributes v) -> fieldMessageSize 24 (messageSize v)
    ; Just (HistoryEvent'MarkerRecordedEventAttributes v) -> fieldMessageSize 25 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionSignaledEventAttributes v) -> fieldMessageSize 26 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionTerminatedEventAttributes v) -> fieldMessageSize 27 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionCancelRequestedEventAttributes v) -> fieldMessageSize 28 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionCanceledEventAttributes v) -> fieldMessageSize 29 (messageSize v)
    ; Just (HistoryEvent'RequestCancelExternalWorkflowExecutionInitiatedEventAttributes v) -> fieldMessageSize 30 (messageSize v)
    ; Just (HistoryEvent'RequestCancelExternalWorkflowExecutionFailedEventAttributes v) -> fieldMessageSize 31 (messageSize v)
    ; Just (HistoryEvent'ExternalWorkflowExecutionCancelRequestedEventAttributes v) -> fieldMessageSize 32 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionContinuedAsNewEventAttributes v) -> fieldMessageSize 33 (messageSize v)
    ; Just (HistoryEvent'StartChildWorkflowExecutionInitiatedEventAttributes v) -> fieldMessageSize 34 (messageSize v)
    ; Just (HistoryEvent'StartChildWorkflowExecutionFailedEventAttributes v) -> fieldMessageSize 35 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionStartedEventAttributes v) -> fieldMessageSize 36 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionCompletedEventAttributes v) -> fieldMessageSize 37 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionFailedEventAttributes v) -> fieldMessageSize 38 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionCanceledEventAttributes v) -> fieldMessageSize 39 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionTimedOutEventAttributes v) -> fieldMessageSize 40 (messageSize v)
    ; Just (HistoryEvent'ChildWorkflowExecutionTerminatedEventAttributes v) -> fieldMessageSize 41 (messageSize v)
    ; Just (HistoryEvent'SignalExternalWorkflowExecutionInitiatedEventAttributes v) -> fieldMessageSize 42 (messageSize v)
    ; Just (HistoryEvent'SignalExternalWorkflowExecutionFailedEventAttributes v) -> fieldMessageSize 43 (messageSize v)
    ; Just (HistoryEvent'ExternalWorkflowExecutionSignaledEventAttributes v) -> fieldMessageSize 44 (messageSize v)
    ; Just (HistoryEvent'UpsertWorkflowSearchAttributesEventAttributes v) -> fieldMessageSize 45 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionUpdateAcceptedEventAttributes v) -> fieldMessageSize 46 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionUpdateRejectedEventAttributes v) -> fieldMessageSize 47 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionUpdateCompletedEventAttributes v) -> fieldMessageSize 48 (messageSize v)
    ; Just (HistoryEvent'WorkflowPropertiesModifiedExternallyEventAttributes v) -> fieldMessageSize 49 (messageSize v)
    ; Just (HistoryEvent'ActivityPropertiesModifiedExternallyEventAttributes v) -> fieldMessageSize 50 (messageSize v)
    ; Just (HistoryEvent'WorkflowPropertiesModifiedEventAttributes v) -> fieldMessageSize 51 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionUpdateAdmittedEventAttributes v) -> fieldMessageSize 52 (messageSize v)
    ; Just (HistoryEvent'NexusOperationScheduledEventAttributes v) -> fieldMessageSize 53 (messageSize v)
    ; Just (HistoryEvent'NexusOperationStartedEventAttributes v) -> fieldMessageSize 54 (messageSize v)
    ; Just (HistoryEvent'NexusOperationCompletedEventAttributes v) -> fieldMessageSize 55 (messageSize v)
    ; Just (HistoryEvent'NexusOperationFailedEventAttributes v) -> fieldMessageSize 56 (messageSize v)
    ; Just (HistoryEvent'NexusOperationCanceledEventAttributes v) -> fieldMessageSize 57 (messageSize v)
    ; Just (HistoryEvent'NexusOperationTimedOutEventAttributes v) -> fieldMessageSize 58 (messageSize v)
    ; Just (HistoryEvent'NexusOperationCancelRequestedEventAttributes v) -> fieldMessageSize 59 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionOptionsUpdatedEventAttributes v) -> fieldMessageSize 60 (messageSize v)
    ; Just (HistoryEvent'NexusOperationCancelRequestCompletedEventAttributes v) -> fieldMessageSize 61 (messageSize v)
    ; Just (HistoryEvent'NexusOperationCancelRequestFailedEventAttributes v) -> fieldMessageSize 62 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionPausedEventAttributes v) -> fieldMessageSize 63 (messageSize v)
    ; Just (HistoryEvent'WorkflowExecutionUnpausedEventAttributes v) -> fieldMessageSize 64 (messageSize v) })
      ...
      loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 acc_8 = do
        ...
        case mTag of
          ...
          Just (Tag fn wt) -> case fn of
            ...
            6 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionStartedEventAttributes v))
            7 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionCompletedEventAttributes v))
            8 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionFailedEventAttributes v))
            9 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionTimedOutEventAttributes v))
            10 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowTaskScheduledEventAttributes v))
            11 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowTaskStartedEventAttributes v))
            12 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowTaskCompletedEventAttributes v))
            13 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowTaskTimedOutEventAttributes v))
            14 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowTaskFailedEventAttributes v))
            15 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskScheduledEventAttributes v))
            16 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskStartedEventAttributes v))
            17 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskCompletedEventAttributes v))
            18 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskFailedEventAttributes v))
            19 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskTimedOutEventAttributes v))
            20 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'TimerStartedEventAttributes v))
            21 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'TimerFiredEventAttributes v))
            22 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskCancelRequestedEventAttributes v))
            23 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityTaskCanceledEventAttributes v))
            24 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'TimerCanceledEventAttributes v))
            25 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'MarkerRecordedEventAttributes v))
            26 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionSignaledEventAttributes v))
            27 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionTerminatedEventAttributes v))
            28 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionCancelRequestedEventAttributes v))
            29 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionCanceledEventAttributes v))
            30 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'RequestCancelExternalWorkflowExecutionInitiatedEventAttributes v))
            31 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'RequestCancelExternalWorkflowExecutionFailedEventAttributes v))
            32 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ExternalWorkflowExecutionCancelRequestedEventAttributes v))
            33 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionContinuedAsNewEventAttributes v))
            34 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'StartChildWorkflowExecutionInitiatedEventAttributes v))
            35 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'StartChildWorkflowExecutionFailedEventAttributes v))
            36 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionStartedEventAttributes v))
            37 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionCompletedEventAttributes v))
            38 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionFailedEventAttributes v))
            39 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionCanceledEventAttributes v))
            40 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionTimedOutEventAttributes v))
            41 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ChildWorkflowExecutionTerminatedEventAttributes v))
            42 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'SignalExternalWorkflowExecutionInitiatedEventAttributes v))
            43 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'SignalExternalWorkflowExecutionFailedEventAttributes v))
            44 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ExternalWorkflowExecutionSignaledEventAttributes v))
            45 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'UpsertWorkflowSearchAttributesEventAttributes v))
            46 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionUpdateAcceptedEventAttributes v))
            47 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionUpdateRejectedEventAttributes v))
            48 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionUpdateCompletedEventAttributes v))
            49 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowPropertiesModifiedExternallyEventAttributes v))
            50 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'ActivityPropertiesModifiedExternallyEventAttributes v))
            51 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowPropertiesModifiedEventAttributes v))
            52 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionUpdateAdmittedEventAttributes v))
            53 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationScheduledEventAttributes v))
            54 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationStartedEventAttributes v))
            55 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationCompletedEventAttributes v))
            56 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationFailedEventAttributes v))
            57 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationCanceledEventAttributes v))
            58 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationTimedOutEventAttributes v))
            59 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationCancelRequestedEventAttributes v))
            60 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionOptionsUpdatedEventAttributes v))
            61 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationCancelRequestCompletedEventAttributes v))
            62 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'NexusOperationCancelRequestFailedEventAttributes v))
            63 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionPausedEventAttributes v))
            64 -> do
              v <- decodeFieldMessage
              loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 (Just (HistoryEvent'WorkflowExecutionUnpausedEventAttributes v))
            _ -> skipField wt >> loop acc_0 acc_1 acc_2 acc_3 acc_4 acc_5 acc_6 acc_7 acc_8
...
instance ProtoFromJSON HistoryEvent where
  protoFromJSON (JsonObject obj) = do
    v_historyEventEventid <- obj .:? "eventId"
    v_historyEventEventtime <- obj .:? "eventTime"
    v_historyEventEventtype <- obj .:? "eventType"
    v_historyEventVersion <- obj .:? "version"
    v_historyEventTaskid <- obj .:? "taskId"
    v_historyEventWorkermayignore <- obj .:? "workerMayIgnore"
    v_historyEventUsermetadata <- obj .:? "userMetadata"
    v_historyEventLinks <- obj .:? "links"
    v_historyEventAttributes <- obj .:? "attributes"
    pure (HistoryEvent {
       historyEventEventid = v_historyEventEventid
      , historyEventEventtime = v_historyEventEventtime
      , historyEventEventtype = v_historyEventEventtype
      , historyEventVersion = v_historyEventVersion
      , historyEventTaskid = v_historyEventTaskid
      , historyEventWorkermayignore = v_historyEventWorkermayignore
      , historyEventUsermetadata = v_historyEventUsermetadata
      , historyEventLinks = v_historyEventLinks
      , historyEventAttributes = v_historyEventAttributes
    })
  protoFromJSON _ = Left "Expected JSON object"
...
instance ProtoFromJSON History where
  protoFromJSON (JsonObject obj) = do
    v_historyEvents <- obj .:? "events"
    pure (History {
       historyEvents = v_historyEvents
    })
  protoFromJSON _ = Left "Expected JSON object"