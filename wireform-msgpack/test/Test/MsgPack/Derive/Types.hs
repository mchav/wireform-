...
-- | Annotated fixture types for the MsgPack deriver round-trip tests.
module Test.MsgPack.Derive.Types (
  Profile (..),
  Tag (..),
  Color (..),
  Shape (..),
...
{-# ANN profilePrivate (forBackend backendMsgPack skip) #-}
{-# ANN profilePrivate (forBackend backendMsgPack (defaults 'defaultPrivate)) #-}
