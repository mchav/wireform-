...
import qualified Data.Map.Strict as Map  -- for instances
import qualified Data.Text as T
import qualified Data.Vector as V        -- for instances
...
deriveProtoFromTranslated TranslatedMessage
  ...
  , tmFields      =
      ...
      , (translatedField 'tagAttrs (ConT ''T.Text) False
