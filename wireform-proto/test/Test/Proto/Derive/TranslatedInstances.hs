...
-- | TH splice site that drives 'Proto.Derive.deriveProtoFromTranslated'
...
deriveProtoFromTranslated TranslatedMessage
  ...
  , tmFields      =
      ...
      , translatedField 'tuserOffset  (ConT ''Int32)      False
          [tag 7, wireOverride WireZigZag]
      , translatedField 'tuserPort    (ConT ''Word32)     False
