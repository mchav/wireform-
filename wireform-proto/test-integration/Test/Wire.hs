...
wireTests =
  describe
    ...
    [ describe
        "Varint encoding/decoding" $ sequence_
        [ it "encode 0" $ do
    ...
    , describe
        "Fixed-width encoding" $ sequence_
    ...
    , describe
        "Protobuf spec conformance vectors" $ sequence_
        [ describe
            "Varint edge cases" $ sequence_
            [ it "varint 0 = [0x00]" $
        ...
        , describe
            "Fixed-width exact bytes" $ sequence_
        ...
        , describe
            "Packed repeated fields" $ sequence_
        ...
        , describe
            "Tag format correctness" $ sequence_
        ...
        , describe
            "Nested messages (length-delimited)" $ sequence_
        ...
        , describe
            "Unknown field skipping" $ sequence_
        ...
        , describe
            "ZigZag spec compliance" $ sequence_
