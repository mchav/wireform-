...
resolverTests = testGroup "Proto.Parser.Resolver"
  [ testCase "resolve simple proto with no imports" $ do
      withTempProtoDir $ \dir -> do
        writeProtoFile (dir </> "simple.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "package test;"
          , "message Foo {"
          , "  string name = 1;"
  ...
  , testCase "resolve proto with local import" $ do
      withTempProtoDir $ \dir -> do
        writeProtoFile (dir </> "dep.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "package dep;"
          , "message Bar {"
          , "  int32 id = 1;"
        ...
        writeProtoFile (dir </> "main.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "package main;"
          , "import \"dep.proto\";"
          , "message Foo {"
  ...
  , testCase "resolve proto with subdirectory import" $ do
      withTempProtoDir $ \dir -> do
        ...
        writeProtoFile (dir </> "sub" </> "dep.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "package sub;"
          , "message Inner {"
          , "  bool flag = 1;"
  ...
  , testCase "well-known import google/protobuf/timestamp.proto resolves" $ do
      withTempProtoDir $ \dir -> do
        writeProtoFile (dir </> "with_ts.proto") $ T.unlines
          [ "syntax = \"proto3\";"
        ...
        case result of
          Left e -> assertFailure ("resolve failed: " <> show e)
          Right rp -> do
            assertBool "timestamp.proto imported"
  ...
  , testCase "missing import returns FileNotFound" $ do
      withTempProtoDir $ \dir -> do
        writeProtoFile (dir </> "bad.proto") $ T.unlines
          [ "syntax = \"proto3\";"
  ...
  , testCase "circular import detected" $ do
      withTempProtoDir $ \dir -> do
        writeProtoFile (dir </> "a.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "import \"b.proto\";"
          , "message A { int32 x = 1; }"
          ]
        writeProtoFile (dir </> "b.proto") $ T.unlines
          [ "syntax = \"proto3\";"
          , "import \"a.proto\";"
          , "message B { int32 y = 1; }"
          ]
