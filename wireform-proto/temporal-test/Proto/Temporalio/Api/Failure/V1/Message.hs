...
import Proto.Temporalio.Api.Enums.V1.Nexus qualified as TE_Enums_V1_Nexus
...
defaultResetWorkflowFailureInfo =
...
defaultChildWorkflowExecutionFailureInfo =
...
defaultNexusOperationFailureInfo =
...
defaultNexusHandlerFailureInfo =
...
instance MessageSize Failure where
  messageSize msg =
    (if msg.failureMessage == T.empty then 0 else fieldTextSize 1 msg.failureMessage)
      ...
      + ( case msg.failureFailureInfo of
            Nothing -> 0
            Just (Failure'FailureInfo'ApplicationFailureInfo v) -> fieldMessageSize 5 (messageSize v)
...
defaultMultiOperationExecutionAborted =
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy ApplicationFailureInfo)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy MultiOperationExecutionAborted)
    . id
