...
data TaskQueueKind
  ...
  | TaskQueueKind'TaskQueueKindWorkerCommands
...
toProtoEnumTaskQueueKind TaskQueueKind'TaskQueueKindWorkerCommands = 3
...
fromProtoEnumTaskQueueKind 3 = Just TaskQueueKind'TaskQueueKindWorkerCommands
...
instance Aeson.ToJSON TaskQueueKind where
  ...
  toJSON TaskQueueKind'TaskQueueKindWorkerCommands = Aeson.String "TASK_QUEUE_KIND_WORKER_COMMANDS"
...
instance Aeson.FromJSON TaskQueueKind where
  parseJSON = \case
    ...
    Aeson.String "TASK_QUEUE_KIND_WORKER_COMMANDS" -> pure TaskQueueKind'TaskQueueKindWorkerCommands
