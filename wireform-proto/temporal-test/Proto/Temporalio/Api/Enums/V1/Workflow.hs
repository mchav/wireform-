...
data ContinueAsNewVersioningBehavior
  ...
  | ContinueAsNewVersioningBehavior'ContinueAsNewVersioningBehaviorUseRampingVersion
    -- ^ Experimental.
...
toProtoEnumContinueAsNewVersioningBehavior ContinueAsNewVersioningBehavior'ContinueAsNewVersioningBehaviorUseRampingVersion = 2
...
fromProtoEnumContinueAsNewVersioningBehavior 2 = Just ContinueAsNewVersioningBehavior'ContinueAsNewVersioningBehaviorUseRampingVersion
...
instance Aeson.ToJSON ContinueAsNewVersioningBehavior where
  ...
  toJSON ContinueAsNewVersioningBehavior'ContinueAsNewVersioningBehaviorUseRampingVersion = Aeson.String "CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_USE_RAMPING_VERSION"
...
instance Aeson.FromJSON ContinueAsNewVersioningBehavior where
  parseJSON = \case
    ...
    Aeson.String "CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_USE_RAMPING_VERSION" -> pure ContinueAsNewVersioningBehavior'ContinueAsNewVersioningBehaviorUseRampingVersion
    Aeson.Number n -> pure (toEnum (round n))
