...
data WorkerDeploymentVersionStatus
  ...
  | WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusDrained
    ...
    -- not query closed workflows. If the user does query closed workflows for some time x after
    -- workflows are closed, they should decommission the version after it has been drained for that duration.
  | WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusCreated
...
toProtoEnumWorkerDeploymentVersionStatus WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusCreated = 6
...
fromProtoEnumWorkerDeploymentVersionStatus 6 = Just WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusCreated
...
instance Aeson.ToJSON WorkerDeploymentVersionStatus where
  ...
  toJSON WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusCreated = Aeson.String "WORKER_DEPLOYMENT_VERSION_STATUS_CREATED"
...
instance Aeson.FromJSON WorkerDeploymentVersionStatus where
  parseJSON = \case
    ...
    Aeson.String "WORKER_DEPLOYMENT_VERSION_STATUS_CREATED" -> pure WorkerDeploymentVersionStatus'WorkerDeploymentVersionStatusCreated
    Aeson.Number n -> pure (toEnum (round n))
