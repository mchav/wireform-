...
import Proto.Temporalio.Api.Enums.V1.Activity qualified as TE_Enums_V1_Activity
...
defaultActivityExecutionOutcome =
...
instance MessageSize ActivityExecutionOutcome where
  messageSize msg =
    ( case msg.activityExecutionOutcomeValue of
        Nothing -> 0
        Just (ActivityExecutionOutcome'Value'Result v) -> fieldMessageSize 1 (messageSize v)
...
defaultActivityExecutionListInfo =
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy ActivityExecutionOutcome)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy ActivityExecutionListInfo)
    . id
