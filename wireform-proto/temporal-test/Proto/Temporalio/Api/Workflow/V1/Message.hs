...
import Proto.Google.Protobuf.FieldMask qualified as PB_FieldMask
...
import Proto.Temporalio.Api.Activity.V1.Message qualified as TE_Activity_V1_Message
...
defaultWorkflowExecutionExtendedInfo =
...
defaultWorkflowExecutionVersioningInfo =
...
defaultDeploymentVersionTransition =
...
defaultWorkflowExecutionConfig =
...
defaultPendingActivityInfo'PauseInfo'Manual =
...
defaultPendingActivityInfo'PauseInfo'Rule =
...
defaultPendingActivityInfo'PauseInfo =
...
instance MessageSize PendingActivityInfo'PauseInfo where
  messageSize msg =
    (maybe 0 (\v -> fieldMessageSize 1 (messageSize v)) msg.pendingActivityInfoPauseInfoPauseTime)
      + ( case msg.pendingActivityInfoPauseInfoPausedBy of
            Nothing -> 0
            Just (PendingActivityInfo'PauseInfo'PausedBy'Manual v) -> fieldMessageSize 2 (messageSize v)
...
instance MessageSize PendingActivityInfo where
  messageSize msg =
    (if msg.pendingActivityInfoActivityId == T.empty then 0 else fieldTextSize 1 msg.pendingActivityInfoActivityId)
      ...
      + ( case msg.pendingActivityInfoAssignedBuildId of
            Nothing -> 0
            Just (PendingActivityInfo'AssignedBuildId'UseWorkflowBuildId v) -> fieldMessageSize 13 (messageSize v)
...
defaultPendingChildExecutionInfo =
...
defaultPendingWorkflowTaskInfo =
...
defaultNewWorkflowExecutionInfo =
...
defaultCallbackInfo'WorkflowClosed =
...
defaultPendingNexusOperationInfo =
...
defaultNexusOperationCancellationInfo =
...
defaultWorkflowExecutionOptions =
...
defaultVersioningOverride'PinnedOverride =
...
instance MessageSize VersioningOverride where
  messageSize msg =
    ( case msg.versioningOverrideOverride of
        Nothing -> 0
        Just (VersioningOverride'Override'Pinned v) -> fieldMessageSize 3 (messageSize v)
...
defaultPostResetOperation'SignalWorkflow =
...
defaultPostResetOperation'UpdateWorkflowOptions =
...
instance MessageSize PostResetOperation where
  messageSize msg =
    ( case msg.postResetOperationVariant of
        Nothing -> 0
        Just (PostResetOperation'Variant'SignalWorkflow v) -> fieldMessageSize 1 (messageSize v)
...
defaultWorkflowExecutionPauseInfo =
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy WorkflowExecutionInfo)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy WorkflowExecutionPauseInfo)
    . id
