...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy EnhancedStackTrace)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy StackTrace)
    . id
