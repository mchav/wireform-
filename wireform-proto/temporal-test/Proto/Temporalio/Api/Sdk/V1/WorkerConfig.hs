...
defaultWorkerConfig'SimplePollerBehavior =
...
defaultWorkerConfig'AutoscalingPollerBehavior =
...
instance MessageSize WorkerConfig where
  messageSize msg =
    (if msg.workerConfigWorkflowCacheSize == 0 then 0 else fieldVarintSize 1 (fromIntegral msg.workerConfigWorkflowCacheSize))
      + ( case msg.workerConfigPollerBehavior of
            Nothing -> 0
            Just (WorkerConfig'PollerBehavior'SimplePollerBehavior v) -> fieldMessageSize 2 (messageSize v)
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy WorkerConfig)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy WorkerConfig'AutoscalingPollerBehavior)
    . id
