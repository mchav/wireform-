...
import Proto.Temporalio.Api.Enums.V1.Namespace qualified as TE_Enums_V1_Namespace
...
defaultNamespaceInfo'Capabilities =
...
registerModuleTypes =
  Proto.Registry.registerType (Proxy :: Proxy NamespaceInfo)
    ...
    . Proto.Registry.registerType (Proxy :: Proxy NamespaceFilter)
    . id
