...
lifecycleSpec :: Spec
lifecycleSpec = describe "Producer/Consumer Lifecycle" $ sequence_
  [ describe "KIP-8: Producer flush()" $ sequence_
  ...
  , describe "KIP-15: Producer close with timeout" $ sequence_
  ...
  , describe "KIP-102: Consumer close with timeout" $ sequence_
  ...
  , describe "Lifecycle Integration" $ sequence_
