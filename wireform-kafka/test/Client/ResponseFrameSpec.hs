...
tests :: Spec
tests = describe "Client.ResponseFrameSpec" $ sequence_
  [ headerVersionTests
  , parseTests
  ]

headerVersionTests :: Spec
headerVersionTests = describe "responseHeaderVersionFor" $ sequence_
  ...
  , describe "request/response header pairing" $ sequence_
...
parseTests :: Spec
parseTests = describe "parseResponseFrame" $ sequence_
