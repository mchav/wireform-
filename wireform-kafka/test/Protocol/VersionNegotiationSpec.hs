...
import "wireform-kafka-protocol" Kafka.Protocol.Message qualified as Msg
...
tests :: Spec
tests =
  describe "Kafka.Protocol.VersionNegotiation" $
    sequence_
      ...
      , describe "toPositive / fallback semantics" $
          sequence_
      ...
      , describe "pickApiVersionFor / pickApiVersionForRange (type-driven)" $
          sequence_
