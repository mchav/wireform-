...
producerRecordSendTotal, producerRecordRetryTotal, producerRecordErrorTotal,
  producerRequestLatencyMs, producerThrottleTimeMs :: Text
...
consumerRecordsConsumedTotal, consumerRecordsLagMax,
  consumerFetchLatencyMs, consumerFetchRequestTotal,
  consumerCommitLatencyMs, consumerRebalanceLatencyMs,
  consumerEndToEndLatencyMs :: Text
