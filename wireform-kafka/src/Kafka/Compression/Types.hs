...
data CompressionCodec
  = -- | No compression (codec ID 0)
    NoCompression
  | -- | Gzip compression (codec ID 1)
    Gzip
  | -- | Snappy compression (codec ID 2)
    Snappy
  | -- | LZ4 compression (codec ID 3)
    Lz4
  | -- | Zstandard compression (codec ID 4)
    Zstd
