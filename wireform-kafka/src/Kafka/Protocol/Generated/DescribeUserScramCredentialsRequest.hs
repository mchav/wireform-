...
-- 'encodeDescribeUserScramCredentialsRequest' / 'decodeDescribeUserScramCredentialsRequest' pair into a
...
instance WC.WireCodec DescribeUserScramCredentialsRequest where
  wireCodec = Just (WC.serialShimCodec encodeDescribeUserScramCredentialsRequest decodeDescribeUserScramCredentialsRequest)
  {-# INLINE wireCodec #-}
