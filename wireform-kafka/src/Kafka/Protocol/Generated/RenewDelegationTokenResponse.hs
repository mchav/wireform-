...
-- 'encodeRenewDelegationTokenResponse' / 'decodeRenewDelegationTokenResponse' pair into a
...
instance WC.WireCodec RenewDelegationTokenResponse where
  wireCodec = Just (WC.serialShimCodec encodeRenewDelegationTokenResponse decodeRenewDelegationTokenResponse)
  {-# INLINE wireCodec #-}
