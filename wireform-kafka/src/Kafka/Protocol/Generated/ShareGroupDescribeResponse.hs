...
-- 'encodeShareGroupDescribeResponse' / 'decodeShareGroupDescribeResponse' pair into a
...
instance WC.WireCodec ShareGroupDescribeResponse where
  wireCodec = Just (WC.serialShimCodec encodeShareGroupDescribeResponse decodeShareGroupDescribeResponse)
  {-# INLINE wireCodec #-}
