...
-- 'encodeAlterPartitionReassignmentsResponse' / 'decodeAlterPartitionReassignmentsResponse' pair into a
...
instance WC.WireCodec AlterPartitionReassignmentsResponse where
  wireCodec = Just (WC.serialShimCodec encodeAlterPartitionReassignmentsResponse decodeAlterPartitionReassignmentsResponse)
  {-# INLINE wireCodec #-}
