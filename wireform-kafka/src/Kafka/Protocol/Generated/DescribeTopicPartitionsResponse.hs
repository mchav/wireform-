...
-- 'encodeDescribeTopicPartitionsResponse' / 'decodeDescribeTopicPartitionsResponse' pair into a
...
instance WC.WireCodec DescribeTopicPartitionsResponse where
  wireCodec = Just (WC.serialShimCodec encodeDescribeTopicPartitionsResponse decodeDescribeTopicPartitionsResponse)
  {-# INLINE wireCodec #-}
