...
-- 'encodeAlterReplicaLogDirsResponse' / 'decodeAlterReplicaLogDirsResponse' pair into a
...
instance WC.WireCodec AlterReplicaLogDirsResponse where
  wireCodec = Just (WC.serialShimCodec encodeAlterReplicaLogDirsResponse decodeAlterReplicaLogDirsResponse)
  {-# INLINE wireCodec #-}
