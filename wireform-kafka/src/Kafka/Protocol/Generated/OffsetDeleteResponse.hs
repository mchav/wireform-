...
-- 'encodeOffsetDeleteResponse' / 'decodeOffsetDeleteResponse' pair into a
...
instance WC.WireCodec OffsetDeleteResponse where
  wireCodec = Just (WC.serialShimCodec encodeOffsetDeleteResponse decodeOffsetDeleteResponse)
  {-# INLINE wireCodec #-}
