...
-- 'encodeReadShareGroupStateRequest' / 'decodeReadShareGroupStateRequest' pair into a
...
instance WC.WireCodec ReadShareGroupStateRequest where
  wireCodec = Just (WC.serialShimCodec encodeReadShareGroupStateRequest decodeReadShareGroupStateRequest)
  {-# INLINE wireCodec #-}
