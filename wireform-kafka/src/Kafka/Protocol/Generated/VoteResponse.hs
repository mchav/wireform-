...
defaultPartitionData = PartitionData { partitionDataPartitionIndex = 0, partitionDataErrorCode = 0, partitionDataLeaderId = 0, partitionDataLeaderEpoch = 0, partitionDataVoteGranted = False }
