...
-- 'encodeOffsetCommitResponse' / 'decodeOffsetCommitResponse' pair into a
...
instance WC.WireCodec OffsetCommitResponse where
  wireCodec = Just (WC.serialShimCodec encodeOffsetCommitResponse decodeOffsetCommitResponse)
  {-# INLINE wireCodec #-}
