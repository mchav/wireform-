...
-- 'encodeReadShareGroupStateResponse' / 'decodeReadShareGroupStateResponse' pair into a
...
instance WC.WireCodec ReadShareGroupStateResponse where
  wireCodec = Just (WC.serialShimCodec encodeReadShareGroupStateResponse decodeReadShareGroupStateResponse)
  {-# INLINE wireCodec #-}
