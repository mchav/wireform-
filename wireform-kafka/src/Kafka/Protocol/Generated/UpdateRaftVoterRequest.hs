...
-- 'encodeUpdateRaftVoterRequest' / 'decodeUpdateRaftVoterRequest' pair into a
...
instance WC.WireCodec UpdateRaftVoterRequest where
  wireCodec = Just (WC.serialShimCodec encodeUpdateRaftVoterRequest decodeUpdateRaftVoterRequest)
  {-# INLINE wireCodec #-}
