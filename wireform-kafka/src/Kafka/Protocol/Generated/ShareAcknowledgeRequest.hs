...
-- 'encodeShareAcknowledgeRequest' / 'decodeShareAcknowledgeRequest' pair into a
...
instance WC.WireCodec ShareAcknowledgeRequest where
  wireCodec = Just (WC.serialShimCodec encodeShareAcknowledgeRequest decodeShareAcknowledgeRequest)
  {-# INLINE wireCodec #-}
