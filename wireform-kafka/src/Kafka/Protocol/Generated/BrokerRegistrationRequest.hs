...
-- 'encodeBrokerRegistrationRequest' / 'decodeBrokerRegistrationRequest' pair into a
...
instance WC.WireCodec BrokerRegistrationRequest where
  wireCodec = Just (WC.serialShimCodec encodeBrokerRegistrationRequest decodeBrokerRegistrationRequest)
  {-# INLINE wireCodec #-}
