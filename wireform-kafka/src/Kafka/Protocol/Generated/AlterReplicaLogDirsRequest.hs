...
-- 'encodeAlterReplicaLogDirsRequest' / 'decodeAlterReplicaLogDirsRequest' pair into a
...
instance WC.WireCodec AlterReplicaLogDirsRequest where
  wireCodec = Just (WC.serialShimCodec encodeAlterReplicaLogDirsRequest decodeAlterReplicaLogDirsRequest)
  {-# INLINE wireCodec #-}
