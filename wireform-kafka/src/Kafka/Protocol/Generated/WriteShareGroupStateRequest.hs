...
-- 'encodeWriteShareGroupStateRequest' / 'decodeWriteShareGroupStateRequest' pair into a
...
instance WC.WireCodec WriteShareGroupStateRequest where
  wireCodec = Just (WC.serialShimCodec encodeWriteShareGroupStateRequest decodeWriteShareGroupStateRequest)
  {-# INLINE wireCodec #-}
