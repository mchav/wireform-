...
-- 'encodeReadShareGroupStateSummaryRequest' / 'decodeReadShareGroupStateSummaryRequest' pair into a
...
instance WC.WireCodec ReadShareGroupStateSummaryRequest where
  wireCodec = Just (WC.serialShimCodec encodeReadShareGroupStateSummaryRequest decodeReadShareGroupStateSummaryRequest)
  {-# INLINE wireCodec #-}
