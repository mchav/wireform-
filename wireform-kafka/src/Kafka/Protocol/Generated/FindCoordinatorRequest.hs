...
-- 'encodeFindCoordinatorRequest' / 'decodeFindCoordinatorRequest' pair into a
...
instance WC.WireCodec FindCoordinatorRequest where
  wireCodec = Just (WC.serialShimCodec encodeFindCoordinatorRequest decodeFindCoordinatorRequest)
  {-# INLINE wireCodec #-}
