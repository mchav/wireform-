...
-- 'encodeSnapshotHeaderRecord' / 'decodeSnapshotHeaderRecord' pair into a
...
instance WC.WireCodec SnapshotHeaderRecord where
  wireCodec = Just (WC.serialShimCodec encodeSnapshotHeaderRecord decodeSnapshotHeaderRecord)
  {-# INLINE wireCodec #-}
