...
-- 'encodeAlterPartitionRequest' / 'decodeAlterPartitionRequest' pair into a
...
instance WC.WireCodec AlterPartitionRequest where
  wireCodec = Just (WC.serialShimCodec encodeAlterPartitionRequest decodeAlterPartitionRequest)
  {-# INLINE wireCodec #-}
