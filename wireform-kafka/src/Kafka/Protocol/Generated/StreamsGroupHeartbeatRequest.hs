...
-- 'encodeStreamsGroupHeartbeatRequest' / 'decodeStreamsGroupHeartbeatRequest' pair into a
...
instance WC.WireCodec StreamsGroupHeartbeatRequest where
  wireCodec = Just (WC.serialShimCodec encodeStreamsGroupHeartbeatRequest decodeStreamsGroupHeartbeatRequest)
  {-# INLINE wireCodec #-}
