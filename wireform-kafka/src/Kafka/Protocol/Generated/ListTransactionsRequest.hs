...
-- 'encodeListTransactionsRequest' / 'decodeListTransactionsRequest' pair into a
...
instance WC.WireCodec ListTransactionsRequest where
  wireCodec = Just (WC.serialShimCodec encodeListTransactionsRequest decodeListTransactionsRequest)
  {-# INLINE wireCodec #-}
