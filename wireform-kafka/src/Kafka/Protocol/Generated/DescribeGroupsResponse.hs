...
-- 'encodeDescribeGroupsResponse' / 'decodeDescribeGroupsResponse' pair into a
...
instance WC.WireCodec DescribeGroupsResponse where
  wireCodec = Just (WC.serialShimCodec encodeDescribeGroupsResponse decodeDescribeGroupsResponse)
  {-# INLINE wireCodec #-}
