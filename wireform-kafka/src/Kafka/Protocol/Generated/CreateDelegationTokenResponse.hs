...
-- 'encodeCreateDelegationTokenResponse' / 'decodeCreateDelegationTokenResponse' pair into a
...
instance WC.WireCodec CreateDelegationTokenResponse where
  wireCodec = Just (WC.serialShimCodec encodeCreateDelegationTokenResponse decodeCreateDelegationTokenResponse)
  {-# INLINE wireCodec #-}
