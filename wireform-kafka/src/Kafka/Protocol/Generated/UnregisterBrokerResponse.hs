...
-- 'encodeUnregisterBrokerResponse' / 'decodeUnregisterBrokerResponse' pair into a
...
instance WC.WireCodec UnregisterBrokerResponse where
  wireCodec = Just (WC.serialShimCodec encodeUnregisterBrokerResponse decodeUnregisterBrokerResponse)
  {-# INLINE wireCodec #-}
