...
-- 'encodeDescribeClientQuotasResponse' / 'decodeDescribeClientQuotasResponse' pair into a
...
instance WC.WireCodec DescribeClientQuotasResponse where
  wireCodec = Just (WC.serialShimCodec encodeDescribeClientQuotasResponse decodeDescribeClientQuotasResponse)
  {-# INLINE wireCodec #-}
