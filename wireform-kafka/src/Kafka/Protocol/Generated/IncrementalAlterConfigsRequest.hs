...
-- 'encodeIncrementalAlterConfigsRequest' / 'decodeIncrementalAlterConfigsRequest' pair into a
...
instance WC.WireCodec IncrementalAlterConfigsRequest where
  wireCodec = Just (WC.serialShimCodec encodeIncrementalAlterConfigsRequest decodeIncrementalAlterConfigsRequest)
  {-# INLINE wireCodec #-}
