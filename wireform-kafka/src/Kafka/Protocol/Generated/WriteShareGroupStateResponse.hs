...
-- 'encodeWriteShareGroupStateResponse' / 'decodeWriteShareGroupStateResponse' pair into a
...
instance WC.WireCodec WriteShareGroupStateResponse where
  wireCodec = Just (WC.serialShimCodec encodeWriteShareGroupStateResponse decodeWriteShareGroupStateResponse)
  {-# INLINE wireCodec #-}
