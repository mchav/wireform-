...
fail_task_surfaces_exception =
  it "FailTask re-throws on the stream thread at the next drain" $ do
    ...
    result <-
      Exception.try (fireDrainPunctuator driver)
