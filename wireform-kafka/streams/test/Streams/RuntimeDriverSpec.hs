...
consumerRecord topic k v off ts =
  KC.ConsumerRecord
    { topic = topic
    , partition = 0
...
consumerRecordPart
  ...
  -> Int64ish
  -> KC.ConsumerRecord
consumerRecordPart topic part k v off ts =
  KC.ConsumerRecord
    { topic = topic
