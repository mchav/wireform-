...
import GHC.Exts (Addr#, Int (..), Int#, indexWord8OffAddr#)
...
fastTagLookup !bs !len = case len of
  ...
  3 -> case BSU.unsafeIndex bs 0 of
    ...
    0x64 {- div/dir -} -> case BSU.unsafeIndex bs 1 of
      0x69 -> case BSU.unsafeIndex bs 2 of
        0x76 -> Just ("div", TagDiv)
        0x72 -> Just ("dir", TagDir)
        _ -> Nothing
      _ -> Nothing
    ...
    0x73 {- sub/sup/svg -} -> case BSU.unsafeIndex bs 1 of
      0x75 -> case BSU.unsafeIndex bs 2 of
        0x62 -> Just ("sub", TagSub)
        0x70 -> Just ("sup", TagSup)
        _ -> Nothing
  ...
  where
    {-# INLINE bs4eq #-}
    bs4eq b a0 a1 a2 a3 =
      BSU.unsafeIndex b 0 == a0
        && BSU.unsafeIndex b 1 == a1
        && BSU.unsafeIndex b 2 == a2
        && BSU.unsafeIndex b 3 == a3
    {-# INLINE bsEq #-}
...
internAttrNameRange !bs !off !end =
  let !n = end - off
      ...
      bl :: Int -> Word8
      bl i =
        let !w = BSU.unsafeIndex bs (off + i)
        in if w >= 0x41 && w <= 0x5A then w + 32 else w
  in case n of
       2 | bl 0 == 0x69, bl 1 == 0x64 -> "id"
       3
         | bl 0 == 0x73, bl 1 == 0x72, bl 2 == 0x63 -> "src"
       ...
       4
         | bl 0 == 0x68, bl 1 == 0x72, bl 2 == 0x65, bl 3 == 0x66 -> "href"
       ...
       5
         | bl 0 == 0x63, bl 1 == 0x6c, bl 2 == 0x61, bl 3 == 0x73, bl 4 == 0x73 -> "class"
       ...
       6
         | bl 0 == 0x68, bl 1 == 0x65, bl 2 == 0x69, bl 3 == 0x67, bl 4 == 0x68, bl 5 == 0x74 -> "height"
