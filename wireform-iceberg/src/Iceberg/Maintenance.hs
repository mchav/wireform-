...
import qualified Iceberg.Snapshot as Snap
...
expireSnapshots
  :: Int64           -- ^ Current wall-clock time in ms.
  -> ExpiryPolicy
  -> TableMetadata
  -> ExpirationResult
...
referencedFilePaths tm = Set.unions
...
orphanFileCandidates
  :: TableMetadata
  -> Set Text     -- ^ All paths discovered in the warehouse.
  -> Set Text
