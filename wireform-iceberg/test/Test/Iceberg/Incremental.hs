...
import Avro.Container qualified as Avro
...
import Iceberg.Manifest qualified as IM
import Iceberg.Read qualified as IR
...
manifestFor path status snapId =
  IW.writeManifestEntries
    ( V.singleton
        ( I.ManifestEntry
            { I.meStatus = status
            , I.meSnapshotId = Just snapId
            , I.meSequenceNumber = Nothing
            , I.meFileSequenceNumber = Nothing
            , I.meFilePath = path
            , I.meFileFormat = I.ParquetFormat
            , I.mePartition = V.empty
            , I.meRecordCount = 100
            , I.meFileSizeBytes = 1024
            , I.meDataFile = Nothing
            }
        )
    )
  ...
  IW.writeManifestList
    ( V.singleton
        ( I.ManifestFile
            ...
            , I.mfContent = content
            , I.mfSequenceNumber = seqNum
            , I.mfMinSequenceNumber = seqNum
            , I.mfAddedSnapshotId = 0
            , I.mfAddedDataFilesCount = Just 1
            , I.mfExistingDataFilesCount = Just 0
            , I.mfDeletedDataFilesCount = Just 0
            , I.mfAddedRowsCount = Just 100
...
tests :: Spec
tests =
  describe "Iceberg.Read incremental scans" $
    sequence_
